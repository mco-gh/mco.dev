...
!(function (e) {
    ...
    function (e, t, n) {
        ...
        var r = {
            ...
            _createMessage: function (e, t) {
                return { type: r.SPOTIFY_MESSAGE, body: { topic: e, data: t ? JSON.parse(JSON.stringify(t)) : null } };
            },
        };
        e.exports = r;
    },
    ...
    function (e, t, n) {
        ...
        function r() {
            ...
            if (((window.Spotify = { Player: e.setupPlayerEnv(window) }), window.onSpotifyWebPlaybackSDKReady)) window.onSpotifyWebPlaybackSDKReady();
            else {
        ...
        var r = n(4),
            ...
            a = function (e, t) {
                var n,
                    ...
                    a = "https://mco.dev/spotify/spotify-player.html",
                    u = s.defer(),
                    c = new r(),
                    _ =
                        t ||
                ...
                return (
                    (f.prototype._sanitizeOptions = function (t) {
                        ...
                        return { name: t.name || n, id: i.get(), getOAuthToken: t.getOAuthToken || t.getOauthToken, volume: t.volume || 1 };
                    }),
                    (f.prototype._setupMessageHandlers = function () {
                        (this._messageHandlers[o.GET_TOKEN] = this._onGetToken.bind(this)),
                            ...
                            (this._messageHandlers[o.CURRENT_STATE] = this._onCurrentState.bind(this)),
                    ...
                    (f.prototype._onGetToken = function (e, t) {
                        ...
                        if ("function" != typeof n) {
                            ...
                            if (this._getListeners(o.PLAYER_INIT_ERROR).length) return void this._onEvent({ name: o.PLAYER_INIT_ERROR, eventData: { message: r } });
                            throw new Error(r);
                        }
                        new s(n).then(
                            function (e) {
    ...
    function (e, t, n) {
        ...
        (function (t) {
            ...
            (r = Object.defineProperty
                ? function (e, t, n) {
                      return e[t] ? e : (Object.defineProperty(e, t, { value: n, configurable: !0, writable: !0 }), e);
                  }
                : function (e, t, n) {
    ...
    function (e, t, n) {
        ...
        (function (t) {
            ...
            e.exports = { get: o, generate: u, generateWithCrypto: r, generateWithRandom: s };
        }.call(t, n(1)));
    },
    function (e, t, n) {
        "use strict";
