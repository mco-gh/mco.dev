...
!(function (t) {
    ...
    function (t, e, i) {
        ...
        (function (e) {
            ...
            (n = Object.defineProperty
                ? function (t, e, i) {
                      return t[e] ? t : (Object.defineProperty(t, e, { value: i, configurable: !0, writable: !0 }), t);
                  }
                : function (t, e, i) {
    ...
    function (t, e, i) {
        ...
        (r.createEvent = function (t, e) {
            ...
            (r.prototype.removeListener = function (t, e, i) {
                ...
                var c = a.REMOVE + t;
                if (r[c] && r[c].length) {
                    if (this.emitSync(c, { listener: e, options: o, remainingLength: s.length - 1 }).defaultPrevented) return this;
                }
            ...
            (r.prototype.emitEventSync = function (t) {
                ...
                for (var r = 0, s = n.length; r < s; r++) {
                    var a = n[r];
                    if ((a.options.once && this.removeListener(e, a.listener, a.options), a.listener.call(this, t), o.wasImmediatePropagationStopped(t))) break;
                }
                return t;
            }),
    ...
    function (t, e, i) {
        ...
        (function (e) {
            ...
            s || ((s = { map: {}, list: [], loggingPredicate: null }), Object.defineProperty ? Object.defineProperty(e, "__dbgLoggerRegistry", { value: s }) : (e.__dbgLoggerRegistry = s));
            var o = s.map,
                a = s.list,
                _ = "log";
            t.exports = {
                ...
                list: function (t) {
                    ...
                    if (t) {
                        var s = [];
                        for (i = 0, n = e.length; i < n; i++) (r = e[i]), o[r] && s.push({ tag: r, description: o[r].description || "No description." });
                        return s;
                    }
                    var a = {};
    ...
    function (t, e, i) {
        ...
        var n = i(9),
            ...
            s = i(6),
            o = (function (t) {
                for (var e, i = 1; i < arguments.length; i++) if ((e = arguments[i])) for (var n in e) n in e && (t[n] = e[n]);
                return t;
            })({}, n, r, {
    ...
    function (t, e, i) {
        "use strict";
        var n = { WIDEVINE: "com.widevine.alpha", PLAYREADY: "com.microsoft.playready", PLAYREADY_HARDWARE: "com.microsoft.playready.hardware", INVALID_SPOTIFY_KEY: "com.spotify.invalid" };
        t.exports = n;
    },
    function (t, e, i) {
        "use strict";
        function n(t, e) {
            (this.url = t || ""), (this.status = e || 0), (this.headers = null), (this.body = null), (this.offline = !1), (this.timing = null), (this.ok = this.status >= 200 && this.status <= 299), (this.metadata = null);
        }
    ...
    function (t, e, i) {
        "use strict";
        var n = { FILE_URLS_MP3: "file_urls_mp3", FILE_URLS_EXTERNAL: "file_urls_external", FILE_IDS_MP4: "file_ids_mp4", FILE_IDS_MP4_DUAL: "file_ids_mp4_dual", MANIFEST_IDS_VIDEO: "manifest_ids_video" };
        t.exports = n;
    },
    function (t, e, i) {
        "use strict";
    ...
    function (t, e, i) {
        "use strict";
        function n(t, e) {
            Error.call(this, e), (this.code = t || r.STORAGE_ERROR), (this.message = e || "Storage Error"), (this.status = -1), (this.fileId = ""), (this.debug = {}), (this.canPlayNext = !0);
        }
        var r = i(4);
    ...
    function (t, e, i) {
        "use strict";
        var n = {
            "com.widevine.alpha": { commonName: "widevine", licenseServer: "https://@webgate/widevine-license", withCertificate: !0, pssh_field: { audio: "pssh_widevine", video: "encryption_data" } },
            "com.microsoft.playready": { commonName: "playready", licenseServer: "https://@webgate/playready-license", withCertificate: !1, pssh_field: { audio: "pssh_playready", video: "encryption_data" } },
            "com.microsoft.playready.hardware": { commonName: "playready", licenseServer: "https://@webgate/playready-license", withCertificate: !1, pssh_field: { audio: "pssh_playready", video: "encryption_data" } },
        };
        t.exports = n;
    },
    function (t, e, i) {
                                ...
                                if (n === l && this._xhr) {
                                    ...
                                    if (r) {
                                        ...
                                        if (
                                            ...
                                            (this._parseResponseHeaders || a > 299) && (c.headers = new o(r.getAllResponseHeaders())),
                                            !this._ignoreResponseBody && a !== _.NO_CONTENT && 2 === c.getStatusFamily())
                                        ) {
                                            var u = this._responseType;
                                            if (!this._forcePolyfill && "response" in r && u === r.responseType) c.body = r.response;
                    ...
                    function (t) {
                        ...
                        if (p)
                            if (this._forcePolyfill) {
                                if (!(p in d)) return e.reject(new TypeError('Cannot polyfill responseType "' + p + '"')), e.promise;
                            } else {
                                if (!("responseType" in _ || p in d)) return e.reject(new TypeError("Cannot set responseType: not supported in browser.")), e.promise;
                                if (((_.responseType = p), p !== this._xhr.responseType && !(p in d))) return e.reject(new TypeError('Unknown responseType "' + p + '".')), e.promise;
                            }
                        var E = this._headers;
                        if (E)
                            for (var f in E)
    ...
    function (t, e, i) {
        ...
        function r(t) {
            var e = t || {};
            (this._curve = e.curve || e.algo || s.curve), (this._baseTime = e.baseTime || s.baseTime), (this._ceiling = e.ceiling || s.ceiling), (this._jitter = !(!1 === e.jitter));
        }
    ...
    function (t, e, i) {
        "use strict";
        var n = i(6),
            r = { BROWSER_ERROR: 0, CONNECTION_ERROR: 0, INFORMATIONAL: 1, SUCCESS: 2, REDIRECTION: 3, CLIENT_ERROR: 4, SERVER_ERROR: 5 };
        t.exports = n(r);
    },
    function (t, e, i) {
        "use strict";
            ...
            function n(t) {
                ...
                (this._navigator = e.navigator),
                    "function" == typeof e.addEventListener &&
                        ...
                        i.notifyBeforeUnload && e.addEventListener(o.WINDOW_BEFORE_UNLOAD, this.emitSync.bind(this, o.WINDOW_BEFORE_UNLOAD, {})));
            }
            var r = i(2),
                s = i(3),
                o = i(10);
    ...
    function (t, e, i) {
        "use strict";
        var n = i(6),
            r = { CONNECT_API: "connect-api", HARMONY: "harmony", PLAYBACK: "playback", TRACK_PLAYBACK: "track-playback", TRANSPORT: "transport" };
        t.exports = n(r);
    },
    function (t, e, i) {
        "use strict";
        ...
        (n.prototype.append = function (t) {
            ...
            (n.prototype.remove = function (t) {
                ...
                return (
                    ...
                    (this.length > 1 ? (t.prev && (t.prev.next = t.next), t.next && (t.next.prev = t.prev), t === this.first ? (this.first = t.next) : t === this.last && (this.last = t.prev)) : ((this.first = null), (this.last = null)),
                    (t.listID = null),
                    (t.prev = null),
                    (t.next = null),
                    this.length--,
    ...
    function (t, e, i) {
        "use strict";
        function n(t, e, i, n) {
            Error.call(this, e), (this.code = t), (this.message = e), (this.status = void 0 !== i ? i : -1), (this.debug = n || {}), (this.target = null);
        }
        ...
        var r = i(29),
            ...
            u = function (t, e) {
                ...
                switch (t.type) {
                    ...
                    case n.Type.TRACK:
                        return (t.context || t.play) && (i += h({ context: t.context, play: t.play })), t.anchor && (i += "#" + t.anchor), [n.Type.TRACK, i];
                    ...
                    case n.Type.EPISODE:
                        return (t.context || t.play) && (i += h({ context: t.context, play: t.play })), [n.Type.EPISODE, i];
                    case n.Type.SHOW:
            ...
            l = function (t, e, i) {
                ...
                switch (f) {
                    ...
                    case n.Type.USER:
                        ...
                        if (null != I)
                            switch (I) {
                                ...
                                case n.Type.COLLECTION:
                                    ...
                                    switch (L) {
                                        case n.Type.ALBUM:
                                            return (a = l()), "missing" === d() ? n.collectionMissingAlbumURI(v, a) : n.collectionAlbumURI(v, a);
                                        case n.Type.ARTIST:
                        ...
                        var O = p();
                        return null != I && O.length > 0 ? n.profileURI(v, [I].concat(O)) : null != I ? n.profileURI(v, [I]) : n.profileURI(v);
                    case n.Type.LOCAL:
                        var N = d(),
                            C = N && c(N, e),
                            P = d(),
                            ...
                            w = d(),
                            U = parseInt(w, 10);
                        return void 0 !== b ? n.localURI(C, D, k, U) : void 0 !== P ? n.localAlbumURI(C, D) : n.localArtistURI(C);
                    case n.Type.IMAGE:
                        return n.imageURI(l());
                    case n.Type.MOSAIC:
    ...
    function (t, e, i) {
        (function (e, i) {
            ...
            !(function (e, i) {
                ...
                function y(t, e, i) {
                    e.constructor === t.constructor && i === c && e.constructor.resolve === u ? T(t, e) : i === tt ? (g(t, tt.error), (tt.error = null)) : void 0 === i ? S(t, e) : n(i) ? f(t, e, i) : S(t, e);
                }
                function m(e, i) {
                ...
                function v(t) {
                    var e = t._subscribers,
                        i = t._state;
                    if (0 !== e.length) {
                        for (var n = void 0, r = void 0, s = t._result, o = 0; o < e.length; o += 3) (n = e[o]), (r = e[o + i]), n ? L(i, n, r, s) : r(s);
                ...
                function L(t, e, i, r) {
                    var s = n(i),
                        ...
                        c = void 0;
                    if (s) {
                        if (((o = I(i, r)), o === tt ? ((c = !0), (a = o.error), (o.error = null)) : (_ = !0), e === o)) return void g(e, l());
                    } else (o = r), (_ = !0);
                ...
                var z = Math.random().toString(36).substring(2),
                            ...
                            (this._instanceConstructor = t),
                                ...
                                x(e)
                                    ? ((this.length = e.length),
                                      ...
                                      0 === this.length ? S(this.promise, this._result) : ((this.length = this.length || 0), this._enumerate(e), 0 === this._remaining && S(this.promise, this._result)))
                                    : g(this.promise, P());
                        }
                        return (
                            ...
                            (t.prototype._settledAt = function (t, e, i) {
                                var n = this.promise;
                                n._state === X && (this._remaining--, t === $ ? g(n, i) : (this._result[e] = i)), 0 === this._remaining && S(n, this._result);
                            }),
                    ...
                    nt = (function () {
                        function t(e) {
                            (this[z] = N()), (this._result = this._state = void 0), (this._subscribers = []), h !== e && ("function" != typeof e && w(), this instanceof t ? O(this, e) : U());
                        }
                        return (
                ...
                return (nt.prototype.then = c), (nt.all = D), (nt.race = b), (nt.resolve = u), (nt.reject = k), (nt._setScheduler = r), (nt._setAsap = s), (nt._asap = G), (nt.polyfill = M), (nt.Promise = nt), nt;
            });
        }.call(e, i(12), i(1)));
    },
    function (t, e, i) {
        ...
        (h.prototype.listen = function () {
            ...
            (h.prototype._onInit = function (t) {
                (this._client = s.create({ getToken: this._getToken.bind(this), endpoints: { webgate: "https://api.spotify.com/v1" }, descriptor: { id: t.id, name: t.name, brand: "public_js-sdk" } })),
                    ...
                    this._streamer.addListeners({ registered: this._onLocalPlayerEnabled.bind(this), state_changed: this._onStateChanged.bind(this), player_initialization_failed: this._onPlayerInitError.bind(this) }),
                    this._streamer.on(_.STREAMER_REGISTRATION_ERROR, this._onRegistrationError.bind(this)),
                    this._client.addListeners({ authentication_error: this._onAuthError.bind(this), error: this._onClientError.bind(this), product_state_changed: this._onProductStateChanged.bind(this) });
                var e = new a();
                e.on("online", this._onLocalPlayerEnabled.bind(this)), e.on("offline", this._onLocalPlayerDisabled.bind(this));
            }),
            ...
            (h.prototype._getToken = function (t) {
                ...
                (this._getTokenRequests[e] = u.defer()), this._getTokenRequests[e].promise.then(this._verifyToken.bind(this)).then(t);
            }),
            (h.prototype._verifyToken = function (t) {
                return this._client
                    ? this._client
                          .request("@webgate/melody/v1/check_scope?scope=web-playback", { authorize: !1, headers: { Authorization: "Bearer " + t } })
                          .then(
                              function (e) {
                                  return 403 === e.status && this._sendMessage(r.authError({ message: "Invalid token scopes." })), t;
                              }.bind(this)
                          )
                          .catch(function () {
                              return t;
            ...
            (h.prototype._onRegistrationError = function (t) {
                var e = t.error;
                e && e.code === c.TP_REGISTRATION_FAILED_NON_PREMIUM && this._sendMessage(r.accountError("This functionality is restricted to premium users only"));
            }),
            (h.prototype._onClientError = function (t) {
                ("listplayer" !== t.source && "playback" !== t.source) || this._sendMessage(r.playbackError({ message: "Playback error" }));
            }),
    ...
    function (t, e, i) {
        ...
        t.exports = {
            create: function (t) {
                ...
                if (t.descriptor && t.descriptor.id && !a.test(t.descriptor.id)) throw new TypeError("Invalid device id.");
                var e,
                    i,
                    _ = {};
                if (t.transport) (e = t.transport), (i = !!t.allowLifecycleManagement);
                else {
                    if ("function" != typeof t.getToken) throw new TypeError("Argument options.getToken must be a function");
                    var c = r(t.xresolve);
                    (e = s({
                        ownerRef: _,
                        providers: {
                ...
                return o.create({ transport: e, ownerRef: _, allowLifecycleManagement: i, descriptor: t.descriptor, playTokenLostBehavior: t.playTokenLostBehavior, hidden: t.hidden });
            },
        };
    },
    function (t, e, i) {
            ...
            return function (t) {
                return (t || s)
                    ...
                    .then(function (t) {
                        ...
                        var n = { dealer: e[i.dealer] && e[i.dealer][0], webgate: e[i.webgate] && e[i.webgate][0], webapi: _ };
    ...
    function (t, e, i) {
        ...
        function n(t) {
            ...
            return r({ ownerRef: t.ownerRef, providers: t.providers, requestMode: t.requestMode, reconnectionRetries: t.reconnectionRetries, forcePolyfillTypes: t.forcePolyfillTypes });
        }
        var r = i(49);
        t.exports = n;
    },
            ...
            r(n, _),
                ...
                (n.prototype._init = function () {
                    this.onAddListener(f.TRANSPORT_CONNECTED, this._onAddListener.bind(this, "connected")),
                        ...
                        this.onRemoveListener(f.TRANSPORT_AUTHENTICATED, this._onRemoveListener.bind(this, "authenticated")),
                        this.onRemoveListener(f.TRANSPORT_CONNECTION_ID, this._onRemoveListener.bind(this, "connection_id")),
                        "fetch" !== this._requestMode || this._Fetch.isSupported() || (y.warn('Default "fetch" request mode unavailable; Fallback to "xhr"'), (this._requestMode = "xhr"));
                    var t = new h();
                    (this._dealer = t),
                ...
                (n.prototype._onAddListener = function (t, e) {
                    if (!e.options.ignoreCurrentState) {
                        ...
                        r[t] || ((r[t] = i.then(this._runStateAwareQueues.bind(this, t))), e.options.once && e.preventDefault());
                    }
                }),
                ...
                (n.prototype._runStateAwareQueues = function (t, e) {
                    for (var i = this._stateAwareListeners[t].splice(0), n = 0, r = i.length; n < r; n++) i[n].call(this, e);
                    ...
                    this._connectionObserver.isOnline() &&
                        (i < 5e3
                            ? (this._reconnectTimeout &&
                                  (clearTimeout(this._reconnectTimeout), this._quickDisconnectCount++, this.emit(f.TRANSPORT_SHORT_SESSION_DISCONNECTED, { disconnectCount: this._quickDisconnectCount, sessionLength: i })),
                              (this._reconnectTimeout = setTimeout(this._tryToReconnect.bind(this), this._counter.getTime(this._quickDisconnectCount))))
                ...
                (n.prototype._onAuthenticated = function () {
                    return clearTimeout(this._reconnectTimeout), (this._authenticationPromise = null), (this._stateMask |= g.AUTHENTICATED), (this._initTime = Date.now()), this.emit(f.TRANSPORT_AUTHENTICATED), c.resolve(!0);
                }),
                (n.prototype._onAuthenticationFailed = function (t) {
                    var e = t && t.error ? t.error : t;
                    return (this._authenticationPromise = null), (this._stateMask &= ~g.AUTHENTICATED), this.emit(f.TRANSPORT_AUTHENTICATION_FAILED, { error: e }), c.reject(e);
                }),
                ...
                (n.prototype._connectToEndpoints = function (t) {
                    ...
                    (this._endpoints = e), this.emit(f.TRANSPORT_ENDPOINTS_RESOLVED, { endpoints: s({}, this._endpoints) });
                    var r = function () {
                ...
                (n.prototype._disconnect = function (t) {
                    return (this._stateMask = 0), this._dealer.disconnect(), t || this.emit(f.TRANSPORT_DISCONNECTED), !0;
                }),
                (n.prototype._refreshToken = function (t) {
                    if (!this._refreshTokenPromise) {
                        ...
                        (this._refreshTokenPromise = this._tokenProvider().then(this._parseProvidedToken)), this._refreshTokenPromise.then(e, e);
                    }
                ...
                (n.prototype._parseProvidedToken = function (t) {
                    ...
                    if ((Array.isArray(t) ? ((e = t[0]), (i = parseInt(t[1] || 3540, 10))) : ((e = t), (i = 3540)), !e))
                        throw ((this._lastToken = null), (this._lastTokenExpiry = 0), new TypeError("Token provider returned an invalid token: " + e));
                    return (this._lastToken = e), (this._lastTokenExpiry = Date.now() + 1e3 * i), this.emit(f.TRANSPORT_ACCESS_TOKEN, { token: e }), e;
                }),
                        ...
                        s = function () {
                            ...
                            return (
                                ...
                                s
                                    .then(
                                        function () {
                                            return "fetch" === t.args.requestMode && this._Fetch.isSupported() ? this._Fetch.request(t.url, t.args) : this._HTTP.request(t.url, t.args);
                                        }.bind(this)
                                    )
                                    .then(function (n) {
                                        var r;
                                        if ((n.headers && (r = n.headers.get("Retry-After")), n.status === p.UNAUTHORIZED && !t.args.ignoreUnauthorized)) return (i = !0), c.reject(n);
                                        if ("function" == typeof e.condition && (e.condition(n, E) || r)) {
                                            var s = parseInt(r, 10);
                                            return S.test(r) ? (n.retryAfter = new Date(r).getTime() - Date.now()) : s > 0 && (n.retryAfter = 1e3 * s), c.reject(n);
                                        }
                                        return n;
                                    })
                            );
                ...
                (n.prototype._sendFireAndForgetRequest = function (t) {
                    return (
                        "function" == typeof e.fetch
                            ...
                            : e.Image
                            ? (new e.Image().src = t)
                            : this.request(t, { requestMode: "xhr", method: "GET", authorize: !1, ignoreResponseBody: !0 }),
                        c.resolve(new l(t, 0))
                    );
                }),
                ...
                (n.prototype.disconnect = function () {
                    ...
                    this._activated = !1;
                    var t = this.isConnected() ? f.TRANSPORT_BEFORE_ONLINE_DISCONNECT : f.TRANSPORT_BEFORE_OFFLINE_DISCONNECT,
                        e = [],
                        i = function (t) {
                            e.push(t);
                        };
                ...
                (n.prototype.forceDisconnect = function () {
                    return this._activated ? ((this._activated = !1), this._disconnect(), c.resolve(!0)) : c.resolve(!1);
                }),
    ...
    function (t, e, i) {
        "use strict";
        var n = function (t, e) {
            for (var i, n = 1; n < arguments.length; n++) if ((i = arguments[n])) for (var r in i) i.hasOwnProperty(r) && (t[r] = i[r]);
            return t;
        };
        t.exports = n;
    },
        ...
        (n.init = function (t, e) {
            ...
            (n.prototype.start = function (t) {
                return (
                    ...
                    this._isRunning || ((this._ts = Date.now()), (this._isRunning = !0), this._backoffInitial ? ((this._callCount = 1), (this._tickInterval = setTimeout(this._tick, this._counter.getTime(0)))) : this._tick()),
            ...
            (n.prototype._failure = function (t) {
                if (t && "retryAfter" in t) this._retryAfter(t);
                    ...
                    this._shouldRetry(e, t) ? (this._callCount++, (this._tickInterval = setTimeout(this._tick, e))) : (this._resolver.reject(t), this._destroy());
                }
            }),
            ...
            !(function () {
                ...
                function i() {
                    if (((u = window.location.origin || window.location.protocol + "//" + window.location.hostname), (c = window.postMessage.bind(window, "@execute_deferreds", u)), !window.__hasDeferredHandler)) {
                        _ ? Object.defineProperty(window, "__hasDeferredHandler", { value: 1 }) : (window.__hasDeferredHandler = 1);
                        var t = function (t) {
                ...
                a && !window.__modDefFn && (_ ? Object.defineProperty(window, "__modDefFn", { value: d }) : (window.__modDefFn = d)), (d.use = { auto: s, dom: i, immediate: n, timeout: r }), (t.exports = d);
            })();
    ...
    function (t, e, i) {
        ...
        function n(t) {
            s.call(this),
                ...
                this.onAddListener(this.EVENT_CONNECTION_ID, this._onAddConnectionIdListener.bind(this, this.on.bind(t))),
                this.onRemoveListener(this.EVENT_CONNECTION_ID, this._onRemoveConnectionIdListener.bind(this, this.removeListener.bind(t)));
        }
        var r = i(2),
            s = i(3),
            o = i(10),
        ...
        r(n, s),
            ...
            (n.prototype._onRemoveConnectionIdListener = function (t, e) {
                e.preventDefault(), e.listener.$proxy_wrapper && t(o.TRANSPORT_CONNECTION_ID, e.listener.$proxy_wrapper, e.options);
            }),
            (t.exports = n);
    },
    function (t, e, i) {
        ...
        (function (e) {
            ...
            r(n, s),
                ...
                (n.prototype._prepareConnectionId = function (t) {
                    ...
                    var i;
                    return (
                        (i = t.header && t.headers["Spotify-Connection-Id"] ? t.headers["Spotify-Connection-Id"] : decodeURIComponent(e[1])),
                ...
                (n.prototype._parseMessage = function (t) {
                    ...
                    if (this._waitingForConnectionId && this._prepareConnectionId(e)) (this._waitingForConnectionId = !1), this._startHeartbeat(!0);
                    else if ("pong" === e.type && this._lastPingDeferred) this._lastPingDeferred.resolve(!0), (this._lastPingDeferred = null);
                ...
                (n.prototype.ping = function () {
                    return this._socket && 1 === this._socket.readyState
                        ? ((this._lastPingDeferred = o.defer()), this._socket.send('{"type":"ping"}'), this._lastPingDeferred.promise)
        ...
        (function (e) {
            ...
            function r(t, i) {
                ...
                var f = r.ignoreResponseBody,
                    T = { mode: r.mode || "cors", credentials: r.credentials || "same-origin", redirect: r.redirect || "follow", method: p };
    ...
    function (t, e, i) {
        ...
        r(n, o),
            ...
            (n.prototype._parseDeviceInfo = function (t, e) {
                ...
                return this._systemInfo.resolve(r.getPlatformIdentifier()), this._clientVersion.resolve(r.getPlatformVersion()), r;
            }),
            (n.prototype._init = function (t) {
                this._initDeviceDescriptor(t), this._initTransport(), this._initLogger();
            }),
            (n.prototype._initLogger = function () {
                this._logger = new f({ transport: this._transport, sdkId: this.getSDKId(), platform: this._systemInfo.promise, clientVersion: this._clientVersion.promise });
            }),
            (n.prototype._initDeviceDescriptor = function (t) {
                this._deviceDescriptor = s
                    ...
                    .then(
                        function (t) {
                            return this.proxyEmit(t, d.DEVICE_DESCRIPTOR_CHANGED, d.CLIENT_DEVICE_DESCRIPTOR_CHANGED), t;
                        }.bind(this)
                    )
                    .catch(
                        function (t) {
            ...
            (n.prototype._onError = function (t, e) {
                this.emit(d.CLIENT_ERROR, { source: t, name: e.name, error: e.error }), e.error && e.error.unrecoverable && this.emit(d.CLIENT_UNRECOVERABLE_FAILURE, { source: t, name: e.name, error: e.error });
            }),
            (n.prototype._onConnected = function () {
                this.emit(d.CLIENT_CONNECTED), (this._transport.hasOwnerRef(this._ownerRef) || this._allowLifecycleManagement) && this._transport.authenticate().catch(function () {});
            }),
            ...
            (n.prototype._onShortSessionDisconnect = function (t) {
                this._logger
                    .logClientEvent({ source: "transport", source_version: A.tagged, source_vendor: "spotify", event: t.type, event_version: "1.0.0", json_data: { disconnectCount: t.disconnectCount, sessionLength: t.sessionLength } })
                    .catch(function (e) {
            ...
            (n.prototype.getUserInfo = function () {
                return this._transport.request("https://@webapi/v1/me", { responseType: "json" }).then(function (t) {
                    ...
                    return e ? { display_name: e.display_name, followers: e.followers, id: e.id, images: e.images, uri: e.uri } : s.reject(new S(R.USER_INFO_REQUEST_EMPTY_RESPONSE, "Unexpected empty response."));
                });
            }),
            ...
            (n.prototype.connect = function () {
                return this._allowLifecycleManagement ? this._transport.connect() : E.connectIfOwned(this._transport, this._ownerRef);
            }),
            (n.prototype.disconnect = function () {
                return this._allowLifecycleManagement ? this._transport.disconnect() : E.disconnectIfOwned(this._transport, this._ownerRef);
            }),
            (n.prototype.forceDisconnect = function () {
                return this._allowLifecycleManagement ? this._transport.forceDisconnect() : E.forceDisconnectIfOwned(this._transport, this._ownerRef);
            }),
        ...
        r(n, s),
            ...
            (n.prototype._fetchData = function (t) {
                ...
                return this._session
                    ...
                    .catch(
                        function (t) {
                            return this.emit("error", { name: "abbaError", error: t }), this._dataDeferred.resolve(!1), !1;
                        }.bind(this)
                    );
            }),
                ...
                return this._authenticated.promise.then(this._fetchData.bind(this, t)).then(
                    function (e) {
                        for (var i = {}, n = 0; n < t.length; n++) {
                            var r = t[n];
                            i[r] = { value: this._flagMap[r] || null, exists: r in this._flagMap, featureName: r, fromAbba: e };
                        }
                        return i;
                    }.bind(this)
                );
    ...
    function (t, e, i) {
        "use strict";
        function n(t) {
            s.call(this), (this._transport = t.transport), (this._endpoint = t.endpoint || c), (this._currentState = null), (this._currentConnectionId = null), (this._handleUserUpdate = this._handleUserUpdate.bind(this)), this._init();
        }
        var r = i(2),
            s = i(3),
            o = i(0),
        ...
        r(n, s),
            ...
            (n.prototype.getCurrentState = function (t) {
                return !t && this._currentState
                    ...
                    : this._transport.request(this._endpoint + "/v1/product_state", { method: "GET", responseType: "json", retry: { condition: this._shouldRetry } }).then(
                          function (t) {
            ...
            (n.prototype.register = function (t) {
                return (
                    ...
                    this._transport.request(this._createSubURL(t), { method: "PUT", ignoreResponseBody: !0, ignoreUnauthorized: !0, retry: { condition: this._shouldRetry } }).then(
                        function (e) {
                            if (e.status !== a.OK) {
                                var i = "Cannot register for product state updates: service responded with status " + e.status;
            ...
            (n.prototype.deregister = function () {
                ...
                return t
                    ? (this._transport.unmatchMessages(u, this._handleUserUpdate),
                      this._transport.request(this._createSubURL(t), { method: "DELETE", ignoreResponseBody: !0, ignoreUnauthorized: !0, retry: { condition: this._shouldRetry } }).then(
                          function (t) {
        ...
        s(r, o),
            ...
            (r.prototype.setCapability = function (t, e) {
                switch (t) {
                    ...
                    default:
                        return (this._capabilities[t] = e), this.emit(a.DEVICE_DESCRIPTOR_CHANGED, { descriptor: this.toJSON() }), !0;
                }
            }),
    ...
    function (t, e, i) {
        "use strict";
        function n(t, e) {
            return t.hasOwnerRef(e) ? t.connect() : o.reject(new _(a.TRANSPORT_LIFECYCLE_DISABLED, "Method `connect` must be called from the Transport instance."));
        }
        function r(t, e) {
            return t.hasOwnerRef(e) ? t.disconnect() : o.reject(new _(a.TRANSPORT_LIFECYCLE_DISABLED, "Method `disconnect` must be called from the Transport instance."));
        }
        function s(t, e) {
            return t.hasOwnerRef(e) ? t.forceDisconnect() : o.reject(new _(a.TRANSPORT_LIFECYCLE_DISABLED, "Method `forceDisconnect` must be called from the Transport instance."));
        }
        var o = i(0),
            a = i(9),
            _ = i(69);
    ...
    function (t, e, i) {
        ...
        (n.prototype = new Error()), (n.prototype.constructor = n), (n.prototype.name = "TransportError"), (t.exports = n);
    },
    function (t, e, i) {
        "use strict";
        function n(t) {
        ...
        (n.create = function (t) {
            ...
            (n.prototype._getIdentData = function () {
                return this._platformId && this._sdkId
                    ? r.resolve({ platform: this._platformId, sdk_id: this._sdkId, client_version: this._clientVersion })
                    : r.all([this._platformPromise, this._sdkIdPromise, this._clientVersionPromise]).spread(
                          function (t, e, i) {
                              return (this._platformId = t), (this._sdkId = e), (this._clientVersion = i), r.resolve({ platform: t, sdk_id: e, client_version: i });
                          }.bind(this)
                      );
            }),
            ...
            (n.prototype.logElapsedTime = function (t) {
                ...
                var e = this._transport,
                    i = { sdk_id: null, platform: null, unique_id: t.unique_id || e.getInitTime(), event: t.event || h.UNKNOWN, elapsed_time: t.elapsed_time || h.ZERO };
                return this._decoratePayload(i).then(this._sendLog.bind(this, d.ELAPSED_TIME));
            }),
            (n.prototype.logJSSDKError = function (t, e) {
                return t ? this._logErrorVariant(d.JSSDK_ERROR, t, e) : r.reject(new TypeError("Logger.logJSSDKError `data` cannot be null."));
            }),
            (n.prototype.logJSSDKWarning = function (t, e) {
                return t ? this._logErrorVariant(d.JSSDK_WARNING, t, e) : r.reject(new TypeError("Logger.logJSSDKWarning `data` cannot be null."));
            }),
            ...
            (n.prototype.logJSSDKIntervalTimer = function (t) {
                ...
                var e = { sdk_id: null, platform: null, timer_name: t.name || h.EMPTY, timer_id: t.id || h.EMPTY, intervals: t.intervals };
            ...
            (n.prototype.logTrackStreamVerification = function (t) {
                ...
                var e = { sdk_id: null, platform: null, play_track: t.play_track, playback_id: t.playback_id, ms_played: t.ms_played, session_id: t.session_id, sequence_id: t.sequence_id, next_playback_id: t.next_playback_id };
    ...
    function (t, e, i) {
        ...
        (function (e) {
            ...
            (n.prototype.start = function (t) {
                t in this._intervals && r.warn("Overriding already started interval"), (this._intervals[t] = { start: o(), end: null });
            }),
            ...
            (i.create = function (t, e) {
                ...
                (i.prototype._walkStepTree = function (t) {
                    for (var e = [], i = 0, n = 0, r = t.children, s = 0; s < r.length; s++) {
                        ...
                        (n = Math.max(a, n)), e.push({ name: o.name, ms_duration: a, parent: "__init__" === t.name ? null : t.name });
                ...
                (i.prototype.calculate = function () {
                    ...
                    var t = this._walkStepTree(this._rootStep),
                        e = { timer_name: this._name, ms_duration: Math.ceil(t.ms_duration), breakdown: t.breakdown, breakdown_version: "1.0.0" };
    ...
    function (t, e, i) {
        ...
        t.exports = function (t, e) {
            ...
            _ || (_ = i.match(r) || [null, "unknown", 0]),
                ...
                "win" === (o = i.match(/ip(?:ad|od|hone)/) ? "ios" : (i.match(/(?:webos|android)/) || i.match(/mac|win|linux|cros/) || ["other"])[0]) && (o = "windows");
            var c = { name: "version" === _[1] ? _[3] : _[1], version: parseFloat("opera" === _[1] && _[4] ? _[4] : _[2]), platform: o || "unknown" };
            return (s[a] = c), c;
        };
    },
    function (t, e, i) {
        ...
        function n(t, e) {
            ...
            var T = o.createACMEPlayer(d, i).then(function (t) {
                ...
                m = r.all([E, y]).spread(function (t, e) {
                    return (
                        t.getCapability("audio_podcasts") && !i.disableExternalFiles && t.appendManifestFormat(u.FILE_URLS_EXTERNAL),
                        e.keySystem !== s.WIDEVINE || i.preferMultiDRMFormat ? t.appendManifestFormat(u.FILE_IDS_MP4_DUAL, u.FILE_IDS_MP4) : t.appendManifestFormat(u.FILE_IDS_MP4, u.FILE_IDS_MP4_DUAL),
                        e.supportsVideo && t.getCapability("video_playback") && t.appendManifestFormat(u.MANIFEST_IDS_VIDEO),
                        t
                    );
                }),
                R = a.create({ trackPlayer: T }),
                S = _.create({ ListClass: c, clientVersion: n, transport: d, logger: l, listPlayer: R, descriptor: m, endpoint: i.endpoint, abbaClient: p, initialVolume: f });
            return new h({ client: t, descriptor: m, listPlayer: R, tpApiClient: S, playerPromise: T, initialVolume: f });
        }
        var r = i(0),
            s = i(14),
            o = i(80),
            ...
            createACMEPlayer: function (t, e) {
                return new n(function (i, n) {
                    ...
                    var d = h.createPlayer || null,
                        ...
                        f = new _(t),
                        T = (h.sdkId || "").split(":"),
                        y = new c({ transport: t, sdk: { name: T[0] || "", version: T[1] || "" }, securityLevel: h.securityLevel });
                    h.ensureEMERobustness && (h.disallowRobustnessValues || (h.disallowRobustnessValues = []), h.disallowRobustnessValues.push(u.EMPTY));
                    var m = {
                        transport: t,
                        createPlayer: d,
        ...
        (function (e) {
            ...
            function o(t) {
                _.call(this),
                    ...
                    this.proxyEmitSync(this._tracker, T.TRACKER_TRACKING_DATA_FINALIZED, T.PLAYER_TRACKING_DATA_FINALIZED),
                    this._tracker.on(T.TRACKER_PLAYED_THRESHOLD_REACHED, this._onPlayedThresholdReached.bind(this)),
                    this._emeManager && (this._emeManager.on(T.EME_LICENSE_REQUEST_CAPPED, this._onLicenseRequestCapped.bind(this)), this._emeManager.on(T.EME_LICENSE_REQUEST_ERROR, this._onLicenseRequestError.bind(this))),
                    this._init();
            }
            var a = i(2),
                _ = i(3),
            ...
            a(o, _),
                (o.prototype._onLicenseRequestError = function (t) {
                    if (t.playId === this._playId) {
                        ...
                        if (e) {
                            var i = t.error;
                            i.shouldRefreshEndpoint && this._licenseURLResolver.remove(e.getKeySystem(), e.getMediaType()), this._emitError(i, !i.unrecoverable, e.toLogJSON());
                        }
                    }
                }),
                ...
                (o.create = function (t) {
                    return t.disableProtection
                        ...
                        : y.create({ transport: t.transport, disallowRobustnessValues: t.disallowRobustnessValues, noServerCertificate: t.noServerCertificate, preferredKeySystems: t.preferredKeySystems }).then(function (e) {
                ...
                (o.prototype._init = function () {
                    this._disableCache && h.info("Cache disabled."),
                        this._transport.on(this._transport.EVENT_CONNECTION_OFFLINE, this._onNavigatorOffline.bind(this)),
                ...
                (o.prototype._recreateMediaElement = function (t, e, i, n) {
                    ...
                    if (s) {
                        if (!this._newElementPerTrack) {
                            ...
                            if (r && o && s.withProtection) return h.info("Reusing old audio player with default protection."), this._newBufferPerTrack && (h.info("Recreating buffer."), this._buffer.recreate(e)), c.resolve(!0);
                            if (r && s.withProtection === t) return h.info("Reusing old audio player with variable protection."), this._newBufferPerTrack && (h.info("Recreating buffer."), this._buffer.recreate(e)), c.resolve(!0);
                        }
                ...
                (o.prototype._getVideoContainer = function () {
                    return "string" == typeof this._videoPlayerContainer ? document.querySelector(this._videoPlayerContainer) : this._videoPlayerContainer || null;
                }),
                ...
                (o.prototype.setPreferredBitrate = function (t) {
                    return "number" != typeof t ? c.resolve(d.INVALID) : (this._acmeTrack && "video" === this._acmeTrack.getMediaType() && t > 0 && this._buffer.abort(!0), this._abrManager.overrideBitrate(t), c.resolve(d.SUCCESS));
                }),
                (o.prototype._createAudioTrack = function (t, e) {
                    var i = { manifestLatency: 0, resolveLatency: 0 };
                    return (this._emeManager ? this._emeManager.getKeySystemInfo() : c.resolve({ keySystem: "com.spotify.invalid" }))
                        .then(
                            function (n) {
                                return E.create({
                        ...
                        .then(
                            function (t) {
                                var n = this._tracker;
                                return n.setResolveLatency(i.resolveLatency), n.setManifestLatency(i.manifestLatency), t.isProtected() && e.fileId && !this._disableCache && this._cache.set(e.fileId, t), t;
                            }.bind(this)
                        );
                }),
                (o.prototype._createVideoTrack = function (t) {
                    ...
                    return this._emeManager
                        ...
                        .then(
                            function (t) {
                                var n = this._tracker;
                                return n.setResolveLatency(e.resolveLatency), n.setManifestLatency(e.manifestLatency), t.isProtected() && i && !this._disableCache && this._cache.set(i, t), t;
                            }.bind(this)
                        );
                }),
                (o.prototype._onDurationChange = function () {
                    var t = this._playId,
                        e = function () {
                            ...
                            this._tracker.setActualDuration(e), this.emit(T.PLAYER_DURATION_CHANGED, { timestamp: Date.now(), position: r(this._player.currentTime), duration: e });
                        }.bind(this);
                ...
                (o.prototype._onPlaying = function () {
                    ...
                    this._tracker.trackPlaying(e), this.emit(T.PLAYER_PLAYING, { timestamp: Date.now(), position: e, logData: t ? t.getLogData() : null });
                }),
                (o.prototype._onPause = function () {
                    ...
                    this._pauseToken = setTimeout(
                        function () {
                            clearTimeout(this._syntheticEndedToken), this.emit(T.PLAYER_PAUSED, { position: t, logData: e });
                        }.bind(this),
                        10
                    );
                }),
                ...
                (o.prototype._onSyntheticEnded = function () {
                    this._synthesizeEnded && this._acmeTrack && this._acmeTrack.isProtected() && (h.info("Synthetic ended emitted."), this._emitEnded());
                }),
                (o.prototype._onError = function () {
                    ...
                    } else (a = R.PLAYER_PLAYBACK_ERROR), (_ = i ? i.message || i.toString() : "Error message undefined"), (c = !0);
                ...
                (o.prototype._onPlayedThresholdReached = function (t) {
                    this._acmeTrack && this.emit(T.PLAYER_PLAYED_THRESHOLD_REACHED, { played: t.played, threshold: t.threshold, position: r(this._player.currentTime) });
                }),
                (o.prototype._emitEnded = function () {
                    "video" === this._acmeTrack.getMediaType() && this.emit(T.PLAYER_ENDED_VIDEO), clearTimeout(this._pauseToken), this.emit(T.PLAYER_ENDED);
                }),
                (o.prototype._emitError = function (t, e, i) {
                    h.error("Player Error", t, i, e),
                        ...
                        this.emit(T.PLAYER_ERROR, { playId: this._playId, error: t, track: i, canPlayNext: e, position: this._player ? r(this._player.currentTime) : 0 });
                }),
                (o.prototype._emitWarning = function (t, e) {
                    h.error("Player Warning", t, e, !0), this._tracker.trackWarning(), this.emit(T.PLAYER_WARNING, { playId: this._playId, error: t, track: e, canPlayNext: !0, position: r(this._player.currentTime) });
                }),
                (o.prototype._prepareMediaElement = function (t, e) {
                    return e === this._playId && this._upcomingACMETrack
                        ? this._recreateMediaElement(this._upcomingACMETrack.isProtected(), this._upcomingACMETrack.getPlayableCodecs(), e, this._upcomingACMETrack.getMediaType()).then(
                              function (t) {
                                  if (!t || e !== this._playId) return h.info("Load ACMETrack dropped after recreate: playId has changed."), c.resolve(!1);
                                  var i = this._player;
                                  return i.withProtection && this._emeManager && (!i.mediaKeys || i.mediaKeys.shouldRefreshPerTrack || this._newMediaKeysPerTrack)
                                      ? this._emeManager
                                            .createMediaKeys(i)
                                            .then(function () {
                                                return !0;
                                            ...
                                            .catch(
                                                function (t) {
                                                    return t.fatal ? t.fatal() : (t.unrecoverable = !0), this._emitError(t, !1, this._upcomingACMETrack.toLogJSON()), c.reject(t);
                                                }.bind(this)
                                            )
                                      : c.resolve(!0);
                              }.bind(this)
                ...
                (o.prototype._handleLoadingComplete = function (t) {
                    ...
                    return "video" === e && i && this._player.parentNode !== i && (i.appendChild(this._player), this.emit(T.PLAYER_VIDEO_ELEMENT_APPENDED)), (this._upcomingACMETrack = null), t;
                }),
                (o.prototype._handleLoadingError = function (t, e, i, n) {
                    if (((this._upcomingACMETrack = null), i !== this._playId)) return c.resolve(!1);
                    if ((this._tracker.trackLoadFailed(), this.emit(T.PLAYER_LOADING_FAILED, { uri: t, logData: e.logData }), n)) {
                ...
                (o.prototype._handleLoadedMetadata = function (t, e, i) {
                    ...
                    if (
                                ...
                                .catch(
                                    function (t) {
                                        if (t) {
                                            ...
                                            if ("NotAllowedError" === t.name) return this.emit(T.PLAYER_AUTOPLAY_FAILED), c.reject(t);
                                        }
                        ...
                        n.readyState > 2 ? (h.info("Ready to play, triggering play."), o()) : (h.info("Waiting to be playable."), this.once(T.INTERNAL_PLAYER_CANPLAY, o));
                    }
                }),
                (o.prototype._handleCanPlayThrough = function (t) {
                    if (t !== this._playId) return void h.info("CanPlayThrough operations dropped: playId has changed.");
                ...
                (o.prototype._loadACMETrack = function (t, e) {
                    ...
                    this.once(
                        ...
                        this.once(T.INTERNAL_PLAYER_LOADED_METADATA, this._handleLoadedMetadata.bind(this, e, this._acmeTrack.getLogData(), t)),
                        this.once(T.INTERNAL_PLAYER_CANPLAYTHROUGH, this._handleCanPlayThrough.bind(this, e));
                    var r = i.isProtected();
                    return this._tracker.setProtected(r), i instanceof f ? this._loadVideoTrack(t, e) : r ? this._loadProtectedTrack(t, e) : this._loadUnprotectedTrack();
                }),
                ...
                (o.prototype._loadVideoTrack = function (t, i) {
                    ...
                    var r = n.getVideoProfile(),
                        s = n.getAudioProfile();
                    this._tracker.trackVideoLoadStart({ bitrate: r.video_bitrate, audioProfile: s, videoProfile: r }), this._tracker.trackBufferLoadStart();
                ...
                (o.prototype._loadProtectedTrack = function (t, i) {
                    ...
                    return (
                        s === n.getFirstFragment()
                            ? (h.info("Appending combined init and playable fragment."), (r = this._buffer.appendFragment(n, n.getHeadFragment())))
                            : (h.info("Appending split init and playable fragment."), (r = c.all([this._buffer.appendFragment(n, n.getInitFragment()), s ? n.getBufferForFragment(s) : c.resolve(!1)]))),
                ...
                (o.prototype._requestLicense = function (t) {
                    ...
                    return (
                        ...
                        c
                            .all([n.getLicenseEndpoint() || this._licenseURLResolver.get(a, n.getMediaType()), n.getInitParams()])
                            .spread(function (n, s) {
                                return u.setLicenseSessionLatency(Date.now() - e), (s.licenseServer = n.replace(/\{contentId\}/, r)), (s.playId = t), (s.mediaKeys = i), _.createSessionWithParams(s);
                            })
                            .then(
                                function (i) {
                                    if (t !== this._playId) return h.info("License tracking dropped: playId has changed."), c.resolve(!1);
                                    i && i.elapsed && (u.setLicenseGenerationLatency(i.elapsed.generate), u.setLicenseRequestLatency(i.elapsed.request), u.setLicenseUpdateLatency(i.elapsed.update));
                                    var n = Date.now() - e;
                                    return u.setKeyLatency(n), this.emit(T.PLAYER_KEY_RECEIVED, { requestTime: n, logData: s }), h.info("License updated."), c.resolve(!0);
                                }.bind(this)
                            )
                            .catch(
                                function (e) {
                ...
                (o.prototype._onTimeUpdate = function () {
                    if (this._loaded) {
                        ...
                        if ((n && (t = this._acmeTrack.getBitrateForTime(this._player.currentTime)), !e && this._lastTimeUpdatePostion && this._lastTimeUpdatePostion === i)) return void h.warn("Dropping duplicate time update.");
                        (this._lastTimeUpdatePostion = e ? 0 : i), (n || this._acmeTrack.isProtected()) && this._buffer.progress(this._acmeTrack, e, i, n);
                        var s = r(i),
                            o = this._acmeTrack ? this._acmeTrack.getLogData() : null;
                        e
                            ? (this._tracker.trackPositionChanged(s, this._player.paused), this.emit(T.PLAYER_POSITION_CHANGED, { position: s, logData: o }))
                            : (this._tracker.trackProgress(s, t), this.emit(T.PLAYER_PROGRESS, { timestamp: Date.now(), position: s, interval: 500, logData: o })),
                            !this._canPreloadEmitted && this._player.duration - i <= 10 ? ((this._canPreloadEmitted = !0), this.emit(T.PLAYER_CAN_PRELOAD)) : (this._canPreloadEmitted = !1),
                            clearTimeout(this._syntheticEndedToken),
                            this._synthesizeEnded && this._acmeTrack.isProtected() && this._isPlaying() && (this._syntheticEndedToken = setTimeout(this._onSyntheticEnded.bind(this), r(this._player.duration - i)));
                    }
                }),
                ...
                (o.prototype.load = function (t, e, i) {
                    ...
                    if ((h.info("load", o), !o)) return c.reject(new S(R.PLAYER_CANNOT_FIND_PLAYABLE_URI, "Cannot find a playable URI."));
                    ...
                    var a = ++this._playId,
                        _ = this._tracker;
                    _.trackLoadStart(o, t.fileId, a.toString(), t.logData), this.emit(T.PLAYER_BEFORE_LOAD, { track: t, options: e, logData: t.logData, uri: o, timestamp: Date.now() }), this._buffer.setPlayId(a);
                    var u = { position: s(n.position || 0), autoplay: !("autoplay" in n) || n.autoplay, callback: i || function () {} };
                    _.setPlayIntended(u.autoplay), _.setPlayedThreshold(n.playedThreshold);
                    var d,
                        l = this._cache;
                    if ("video" === t.mediaType && !this._emeManager) return c.reject(new S(R.DISALLOW_PROTECTED_TRACK_ERROR, "Protected tracks not supported"));
                    var p = "video" === t.mediaType ? this._createVideoTrack.bind(this, t) : this._createAudioTrack.bind(this, o, t, a),
                    ...
                    return (
                        E
                            ? (h.info("Waiting for preloading track.", t.fileId),
                              (d = E.then(
                                  function (e) {
                                      return h.info("Preloading succeeded.", t.fileId), _.setResolveLatency(e.resolveLatency), _.setManifestLatency(e.manifestLatency), l.get(t.fileId);
                                  },
                                  function () {
                            ...
                            .then(
                                function (e) {
                                    return e.isProtected() && !this._emeManager
                                        ? c.reject(new S(R.DISALLOW_PROTECTED_TRACK_ERROR, "Protected tracks not supported"))
                                        : (e.setLogData(t.logData), _.setCalculatedDuration(r(e.getCalculatedDuration())), (this._upcomingACMETrack = e), c.resolve());
                                }.bind(this)
                            )
                ...
                (o.prototype.preload = function (t) {
                    ...
                    var _ = { manifestLatency: 0, resolveLatency: 0 },
                        u = this._emeManager
                            ...
                            .catch(
                                function (t) {
                                    return (a[i] = null), this.emit(T.PLAYER_PRELOADING_ERROR, { error: t, track: t.track || null, canPlayNext: !("canPlayNext" in t) || t.canPlayNext, preloading: !0 }), c.reject(t);
                                }.bind(this)
                            );
                    return (a[i] = u), u;
                }),
                ...
                (o.prototype.getPlayerState = function () {
                    var t = this._player;
                    return { playing: this._isPlaying(), position: t ? r(t.currentTime) : 0, duration: t ? r(t.duration) : 0, volume: t ? this._playerVolume : 1 };
                }),
                ...
                (o.prototype.stop = function (t, i) {
                    var n = [],
                        r = t || {};
                    if ((this.emit(T.PLAYER_BEFORE_STOP, { timestamp: Date.now(), logData: r }), this._tracker.trackStopped(t), this._buffer.abort(!0), this._emeManager && n.push(this._emeManager.destroySessions()), this._player)) {
                        (this._fatalOnNextError = this._shouldNextErrorBeFatal()), this._fatalOnNextError && h.warn("MediaError detected: next immediate media error will be fatal.");
                    ...
                    if ((this._acmeTrack && this._disableCache && this._acmeTrack.clearCachedBuffers(), this._acmeTrack && "video" === this._acmeTrack.getMediaType())) {
                        ...
                        u && this._player.parentNode === u && (this._newElementPerTrack || "video" !== i) && (u.removeChild(this._player), this.emit(T.PLAYER_VIDEO_ELEMENT_REMOVED));
                    }
                    return (
    ...
    function (t, e, i) {
        ...
        (function (e) {
            function n(t) {
                (this._defaultBandwidth = t || s), (this._totalBytes = 0), (this._short = new r(2)), (this._long = new r(5)), (this._overrideBitrate = 0), (this._onConnectionChange = this._onConnectionChange.bind(this)), this._init();
            }
            var r = i(84),
                s = 4e5;
            (n.prototype._init = function () {
                e.navigator && e.navigator.connection && e.navigator.connection.downlink && ((this._defaultBandwidth = 1e6 * e.navigator.connection.downlink), e.navigator.connection.addEventListener("change", this._onConnectionChange));
            }),
        ...
        (function (e) {
            ...
            (n.create = function (t) {
                ...
                (n.prototype.resolve = function (t) {
                    if (this._bypassResolve) return t && (t.resolveLatency = 0), s.resolve({ lid: null, uri: this._resolvedURL, protection: !!this._preloadedManifest || !this._noManifest });
                        ...
                        e
                            .then(
                                function (t) {
                                    ...
                                    return (this._fallbackURLs = t.uris), (this._resolvedURL = this._fallbackURLs.shift()), t;
                                }.bind(this)
                            )
                            .catch(
                                function (t) {
                ...
                (n.prototype._getManifest = function (t) {
                    ...
                    if (this._preloadedManifest) return t && (t.manifestLatency = 0), s.resolve(this._preloadedManifest);
                    var e = Date.now();
                ...
                (n.prototype._calculateFragments = function (t) {
                    var e = t.offset;
                    this._initFragment = { init: !0, cacheBuffer: !this._disableCache, bufferURL: null, buffer: null, byteStart: 0, byteEnd: e - 1, codec: this._codec };
                    for (var i = t.segments, n = t.timescale, r = 0, s = i.length, o = new Array(s), a = 0, _ = 0, c = s; _ < c; _++) {
                        var u = i[_],
                            h = u[0],
                            d = u[1],
                            l = d / n;
                        (o[_] = { cacheBuffer: !_ && !this._disableCache, bufferURL: null, buffer: null, byteStart: e, byteEnd: e + (h - 1), timeStart: r, timeEnd: r + l, codec: this._codec }), (e += h), (a += d), (r += l);
                    }
                    var p = o[o.length - 1].byteEnd;
                    (o[o.length - 1].isLastFragment = !0), (this._fragments = o), (this._duration = a / n), (this._frontPaddingDuration = 1024 / 44100), (this._endPaddingDuration = (1024 - (p % 1024) + 2048) / n);
                }),
                (n.prototype._calculateFragmentsV1 = function (t) {
                    var e = t.offset;
                    this._initFragment = { init: !0, cacheBuffer: !this._disableCache, buffer: null, byteStart: 0, byteEnd: e - 1, codec: this._codec };
                    for (var i = t.references, n = t.timescale, r = 0, s = i.length, o = new Array(s), a = 0, _ = 0, c = s; _ < c; _++) {
                        var u = i[_],
                            h = u.duration / n;
                        (o[_] = { cacheBuffer: !_ && !this._disableCache, buffer: null, byteStart: e, byteEnd: e + (u.size - 1), timeStart: r, timeEnd: r + h, codec: this._codec }), (e += u.size), (a += u.duration), (r += h);
                    }
                ...
                (n.prototype.getBufferForFragment = function (t) {
                    if (!t) return null;
                    if (t.buffer) return s.resolve({ audio: { bufferURL: t.bufferURL, buffer: t.buffer, codec: this._codec, bandwidth: null } });
                    if (!this._resolvedURL) return s.reject(new a(_.FILE_NOT_RESOLVED, "Cannot fetch buffer: No resolved URL"));
                    var e = s.defer();
                        ...
                        .request(u, {
                            ...
                            retry: {
                                condition: function (t, e) {
                                    ...
                                    var i = t.getStatusFamily();
                                    return i === e.CONNECTION_ERROR || i === e.SERVER_ERROR || (!(i !== e.SUCCESS || !t.body) && t.body.byteLength !== n);
                                },
                            },
                        })
                        .then(
                            function (a) {
                                switch ((this._endFetching(e.resolve), a.status)) {
                                    case 0:
                                        if (a.offline) return s.reject(new o(_.FRAGMENT_OFFLINE_REQUEST_FAILED_WITH_ZERO, "Request failed with status 0.", 0, { time_range: c, byte_range: r }));
                                        var h = new o(_.FRAGMENT_ONLINE_REQUEST_FAILED_WITH_ZERO, "Request failed with status 0.", 0);
                                        return (
                                            (i = !1),
                                            this._resolvedURL !== u ? (i = !0) : this._fallbackURLs.length && this._resolvedURL === u && ((i = !0), (this._resolvedURL = this._fallbackURLs.shift())),
                                            (h.debug.has_fallback = i),
                                            i ? (this._emitWarning(h, this.toLogJSON()), this.getBufferForFragment(t)) : s.reject(h)
                                        );
                                    case 200:
                                    case 206:
                                        if (!a.body) return s.reject(new o(_.FRAGMENT_REQUEST_EMPTY_RESPONSE, "Empty response for successful buffer.", a.status, { time_range: c, byte_range: r }));
                                        var d = a.body;
                                        if (d.byteLength !== n)
                                            return s.reject(
                                                new o(_.FRAGMENT_REQUEST_UNEXPECTED_LENGTH, "Received buffer of unexpected length.", a.status, { time_range: c, byte_range: r, received_length: d.byteLength, expected_length: n })
                                            );
                                        if (t.cacheBuffer && d && d.byteLength) {
                                            ...
                                            if (l && l.length)
                                                for (var p = 0, E = t.sliceInto.length; p < E; p++) {
                                                    var f = l[p];
                                                    f.fragment && f.fragment.cacheBuffer && ((f.fragment.bufferURL = u), (f.fragment.buffer = d.slice(f.start, f.end)));
                                                }
                                        }
                                        return this._abrManager.sample(d.byteLength, a.timing.completed), { audio: { bufferURL: u, buffer: d, codec: this._codec, bandwidth: (8e3 * d.byteLength) / a.timing.completed } };
                                    case 403:
                                    ...
                                    default:
                                        return (
                                            (i = !1),
                                            this._resolvedURL !== u ? (i = !0) : this._fallbackURLs.length && this._resolvedURL === u && ((i = !0), (this._resolvedURL = this._fallbackURLs.shift())),
                                            i ? this.getBufferForFragment(t) : s.reject(new o(_.FRAGMENT_REQUEST_FAILED_WITH_STATUS, "Buffer request failed with status " + a.status, a.status, { time_range: c, byte_range: r }))
                                        );
                                }
                            }.bind(this)
                        );
                    ...
                    return this._loaded
                        ...
                        : s.all([this.resolve(i), this._getManifest(i)]).spread(
                              function (t, i) {
                                  ...
                                  if (this._keySystem === u.INVALID_SPOTIFY_KEY) return (this._protection = i.protection || "cenc"), (this._psshBox = new e.Uint8Array()), this;
                                  var n,
                                      r = this._keySystemSettings.pssh_field.audio,
                                      o = i[r];
                                  if (!o) {
                                      if ("pssh_widevine" !== r) return (n = new a(_.FILE_FORMAT_NOT_SUPPORTED, "KeySystem does not support the file format.")), (n.track = this.toLogJSON()), s.reject(n);
                                      o = i.pssh;
                                  }
                                  if (
                                      ((this._protection = i.protection || "cenc"),
                                      (this._psshBox = this._parsePSSHBox(o || "AAAAT3Bzc2gAAAAA7e+LqXnWSs6jyCfc1R0h7QAAAC8IARIQjkdvXv0rqMqeUvuJdEQ6BxoHc3BvdGlmeSIQU5XxcNx4EeWn2APhWavFng==")),
                                      i.segments)
                                  )
                                      this._calculateFragments(i);
                                  else {
                                      if (!i.references) return (n = new a(_.FILE_MALFORMED_SEEKTABLE, "Malformed seektable.")), (n.track = this.toLogJSON()), s.reject(n);
            ...
            (n.create = function (t) {
                ...
                (n.prototype._calculateFragments = function (t) {
                    ...
                    this._initFragment = {
                        ...
                        bitrate: 0,
                        quality: 0,
                        audio: { bufferURL: null, buffer: null, codec: this._constructAudioMimeType(this._audioProfile) },
                        video: { bufferURL: null, buffer: null, codec: this._constructVideoMimeType(this._videoProfile) },
                    };
                ...
                (n.prototype._calculateVariants = function (t, e) {
                    for (var i = this._videoCodec, n = this._videoMimeType, r = this._audioCodec, s = this._audioMimeType, o = [], a = [], _ = 0, c = t.length; _ < c; _++) {
                        var u = t[_];
                        u.video_codec === i && u.mime_type === n && u.encryption_index === e ? o.push(u) : u.audio_codec === r && u.mime_type === s && u.encryption_index === e && a.push(u);
                    }
                ...
                (n.prototype._constructFragmentURL = function (t) {
                    return t.init
                        ...
                        : this._resolver.getSegmentURLs(this._baseURL, this._segmentTemplate, t.timeStart, this._audioProfile, this._videoProfile);
                }),
                (n.prototype._fetchBufferForFragment = function (t) {
                    if (!t.fetchingBufferPromise) {
                        ...
                        t.fetchingBufferPromise = r
                            .all([this._transport.request(s.audio, n).then(this._parseFragmentResponse.bind(this, t, "audio")), this._transport.request(s.video, n).then(this._parseFragmentResponse.bind(this, t, "video"))])
                            .spread(
                                function (n, r) {
                                    return (
                                        (t.quality = i),
                                        (t.bitrate = this._videoProfile.video_bitrate),
                                        t.cacheBuffer && ((t.audio.buffer = n.buffer), (t.audio.bufferURL = s.audioLogging), (t.video.buffer = r.buffer), (t.video.bufferURL = s.videoLogging)),
                                        (t.fetchingBufferPromise = null),
                                        this._abrManager.sample(n.buffer.byteLength + r.buffer.byteLength, Date.now() - e),
                                        this._updateVariants(),
                                        {
                                            audio: { bufferURL: s.audioLogging, buffer: n.buffer, codec: t.audio.codec, bandwidth: n.bandwidth },
                                            video: { bufferURL: s.videoLogging, buffer: r.buffer, codec: t.video.codec, bandwidth: r.bandwidth },
                                        }
                                    );
                                }.bind(this)
                            )
                ...
                (n.prototype._parseFragmentResponse = function (t, e, i) {
                    ...
                    switch (i.status) {
                        case 0:
                            return r.reject(new o(a.FRAGMENT_REQUEST_FAILED_WITH_ZERO, "Request failed with status 0.", 0, { time_range: n, codec: s, quality: t.quality }));
                        case 200:
                        case 206:
                            return i.body
                                ? r.resolve({ buffer: i.body, bandwidth: (8e3 * i.body.byteLength) / i.timing.completed })
                                : r.reject(new o(a.FRAGMENT_REQUEST_EMPTY_RESPONSE, "Empty response for successful buffer.", i.status, { time_range: n, codec: s, quality: t.quality }));
                    }
                    return r.reject(new o(a.FRAGMENT_REQUEST_FAILED_WITH_STATUS, "Buffer request failed with status " + i.status, i.status, { time_range: n, codec: s, quality: t.quality }));
                }),
                ...
                (n.prototype.getBufferForFragment = function (t) {
                    return t.audio.buffer && t.video.buffer && t.quality >= this._videoProfile.video_resolution
                        ? r.resolve({
                              audio: { bufferURL: t.audio.bufferURL, buffer: t.audio.buffer, codec: t.audio.codec, bandwidth: null },
                              video: { bufferURL: t.video.bufferURL, buffer: t.video.buffer, codec: t.video.codec, bandwidth: null },
                          })
                        : this._fetchBufferForFragment(t);
                }),
                (n.prototype.clearCachedBuffers = function () {
                    this._initFragment && ((this._initFragment.audio.buffer = null), (this._initFragment.video.buffer = null)),
                        this._fragments.forEach(function (t) {
                            (t.audio.buffer = null), (t.video.buffer = null);
                        });
                }),
                (n.prototype._parsePSSHBox = function (t) {
                    for (var i = s.decode(t), n = new e.Uint8Array(i.length), r = 0, o = i.length; r < o; r++) n[r] = i.charCodeAt(r);
                    return n;
                }),
                ...
                (n.prototype.load = function (t) {
                    ...
                    return this._resolver.getManifest(this._fileId).then(
                        function (t) {
                            ...
                            var n,
                                s = t.contents[0];
                            if (!s) return (n = new _(a.FILE_MALFORMED_SEEKTABLE, "Malformed seektable: no contents.")), (n.track = this.toLogJSON()), r.reject(n);
                            ...
                            if (s.encryption_infos && s.encryption_infos.length) {
                                for (var c, u = s.encryption_infos, h = this._keySystemSettings.commonName, d = 0, l = u.length; d < l; d++) {
                                    var p = u[d];
                                    if (p && p.key_system === h) {
                                ...
                                if (!c) return (n = new _(a.FILE_FORMAT_NOT_SUPPORTED, "KeySystem does not support the file format.")), (n.track = this.toLogJSON()), r.reject(n);
                                this._protection = "cenc";
                                try {
                                    this._psshBox = this._parsePSSHBox(c);
                                } catch (t) {
                                    return (n = new _(a.FILE_MALFORMED_PSSH, "Invalid PSSH value.")), (n.track = this.toLogJSON()), r.reject(n);
                                }
                            }
                            return (
                ...
                (n.prototype.getPlayableCodecs = function () {
                    return [this._constructAudioMimeType(this._audioProfile), this._constructVideoMimeType(this._videoProfile)];
                }),
                (n.prototype.getResolvedURL = function () {
                    return this._resolvedURL;
                }),
                ...
                (n.prototype.toLogJSON = function () {
                    return { uri: this._uri, fileId: this._fileId, format: this._format, resolved_url: "unknown-video" };
                }),
                (t.exports = n);
        }.call(e, i(1)));
    },
        ...
        (function (e) {
            function n(t) {
                _.call(this),
                    ...
                    (this._preferredKeySystems = t.preferredKeySystems || [h.WIDEVINE, h.PLAYREADY, h.PLAYREADY_HARDWARE]),
            ...
            r(n, _),
                (n.create = function (t) {
                    return new s(function (e) {
                        var i = d.install();
                        if (!i) throw new o(u.EME_API_NOT_SUPPORTED, "Platform does not support navigator.requestMediaKeySystemAccess").fatal();
                        (t.emeImpl = i), e(new n(t).init());
                    });
                }),
                (n.prototype._prepareConfiguration = function (t) {
                    var e = t.getConfiguration();
                    f.info("KeySystem configured as ", e.label), (e.audioCapabilities && e.audioCapabilities.length) || this._appendProbableMediaCapabilities(t.keySystem, e);
                    var i = { keySystem: t.keySystem, keySystemImpl: this._emeImpl, audioFormats: this._parseCapabilities(e.audioCapabilities), videoFormats: this._parseCapabilities(e.videoCapabilities) };
                ...
                (n.prototype._appendProbableMediaCapabilities = function (t, i) {
                    for (var n = this._configs, r = 0, s = n.length; r < s; r++) {
                        ...
                        if (u.audioCapabilities && u.audioCapabilities.length)
                            for (l = !1, o = 0, a = u.audioCapabilities.length; o < a; o++) (_ = u.audioCapabilities[o]), (c = _.contentType), e.MediaSource.isTypeSupported(c) && (d.audioCapabilities.push(_), (l = !0));
                        if (u.videoCapabilities && u.videoCapabilities.length)
                            for (l = !1, o = 0, a = u.videoCapabilities.length; o < a; o++)
                                (_ = u.videoCapabilities[o]),
                                    (c = _.contentType),
                                    (-1 === c.indexOf("webm") || (t !== h.PLAYREADY && t !== h.PLAYREADY_HARDWARE)) && e.MediaSource.isTypeSupported(c) && (d.videoCapabilities.push(_), (l = !0));
                        if (l) return (i.audioCapabilities = d.audioCapabilities), void (i.videoCapabilities = d.videoCapabilities);
                    }
                }),
                ...
                (n.prototype._extractPlayReadyChallenge = function (t, i) {
                    ...
                    if (s.getElementsByTagName("Challenge")[0])
                        try {
                            ...
                            if (a.length !== _.length) throw new o(u.EME_HEADER_KEY_VALUE_MISMATCH, "Mismatched header <name>/<value> pair in key message");
                        } catch (t) {
                            this.emit(c.EME_LICENSE_REQUEST_ERROR, { playId: i, error: t }), (n = null);
                        }
                    else this.emit(c.EME_LICENSE_REQUEST_ERROR, { playId: i, error: new o(u.EME_HEADER_KEY_VALUE_MISMATCH, "Mismatched header <name>/<value> pair in key message") });
                    return n;
                }),
                (n.prototype._onMessage = function (t, e) {
                    (t.timeMap.generate.end = Date.now()), f.info("Got EME message event with type", e.messageType);
                    var i = e.message;
                    if ((i && t.keySystem === h.PLAYREADY && (i = this._extractPlayReadyChallenge(i, t.playId)), !i)) return void f.info("Ignoring message event: no valid request payload");
                ...
                (n.prototype._handleLicenseResponse = function (t, i) {
                    var n = function (e) {
                        (e.playId = t.playId), (e.licenseServer = t.licenseServer), this.emit(c.EME_LICENSE_REQUEST_ERROR, { playId: t.playId, error: e });
                    }.bind(this);
...
i.status = 200;
                    if (200 !== i.status) {
                        ...
                        402 === i.status
                            ? this.emit(c.EME_LICENSE_REQUEST_CAPPED, { playId: t.playId, error: new a(u.CAPPING_USER_IS_CAPPED, "User is capped.") })
                            : 400 === i.status && "widevine error" === s
                            ? ((r = new o(u.EME_LICENSE_REQUEST_WIDEVINE_ERROR, "Widevine license server failed to parse request.")), (r.status = i.status), (r.shouldRefreshEndpoint = !0), r.fatal(), n(r))
                            : ((r = new o(u.EME_LICENSE_REQUEST_FAILED_WITH_STATUS, "License request failed (" + (s || "unknown") + ")")), (r.status = i.status), (r.shouldRefreshEndpoint = 400 === i.status || 403 === i.status), n(r));
                    } else {
                        if (!i.body) return (r = new o(u.EME_LICENSE_REQUEST_EMPTY_RESPONSE, "Empty license response body")), (r.status = i.status), void n(r);
                        try {
                ...
                (n.prototype.destroySessions = function () {
                    for (var t = [], e = this._keySessions, i = 0, n = e.length; i < n; i++)
                        try {
                            var r = e[i],
                                o = r.keySession;
                            o.removeEventListener(c.KEY_SESSION_MESSAGE, r.onMessageListener), o.removeEventListener(c.KEY_SESSION_STATUSES_CHANGE, r.onKeyStatusChangeListener);
                ...
                (n.prototype.init = function () {
                    for (var t = this._keySystemDeferred, i = e.navigator, n = {}, r = [], a = [], _ = 0, c = p.length; _ < c; _++) {
                        var d = p[_];
                    ...
                    return s
                        ...
                        .then(
                            function (t) {
                                return t ? this._testMediaKeys(t) : s.reject(new o(u.EME_NO_SUPPORTED_KEYSYSTEM, "No supported keysystem was found."));
                            }.bind(this)
                        )
                        .then(
                            function (e) {
                ...
                (n.prototype._testMediaKeys = function (t) {
                    return new s(function (e) {
                        ...
                        function (e) {
                            if (!e) return s.reject(new o(u.EME_MEDIA_KEYS_NOT_SUPPORTED, "Cannot create MediaKeys from KeySystemAccess").fatal());
                            try {
                                if (!e.createSession()) throw new Error("");
                            } catch (t) {
                                return s.reject(new o(u.EME_MEDIA_KEY_SESSION_NOT_SUPPORTED, t.message || "Cannot create MediaKeySession from KeySystemAccess").fatal());
                            }
                            return t;
                        },
                        function (t) {
                            return f.error(t.name), s.reject(new o(u.EME_MEDIA_KEYS_NOT_SUPPORTED, t.message || "Unknown error").fatal());
                        }
                    );
                }),
                (n.prototype.createMediaKeys = function (t) {
                    return this._keySystemDeferred.promise
                        ...
                        .spread(
                            function (e, i) {
                                if (!t.mediaKeys) throw new o(u.EME_PLAYER_MEDIA_KEYS_SETTING_FAILED, "Failed to set MediaKeys on HTMLMediaElement");
                    ...
                    return new s(
                        function (e, i) {
                            ...
                            var n = t.mediaKeys.createSession(),
                                r = { generate: { start: 0, end: 0 }, request: { start: 0, end: 0 }, update: { start: 0, end: 0 } },
                                a = this._onMessage.bind(this, { keySystem: t.keySystem, keySession: n, licenseServer: t.licenseServer || this._keySystemSettings.licenseServer, playId: t.playId, timeMap: r });
                            n.addEventListener(c.KEY_SESSION_MESSAGE, a);
                            var _ = function () {
                                f.info("KeyStatus change"),
                                    (r.update.end = Date.now()),
                                    e({ elapsed: { generate: Math.max(r.generate.end - r.generate.start, 0), request: Math.max(r.request.end - r.request.start, 0), update: Math.max(r.update.end - r.update.start, 0) } });
                            };
                            n.addEventListener(c.KEY_SESSION_STATUSES_CHANGE, _),
                                this._saveSession({ keySession: n, onMessageListener: a, onKeyStatusChangeListener: _ }),
            ...
            t.exports = {
                install: function () {
                    ...
                    return t && t.requestMediaKeySystemAccess && e.MediaKeySystemAccess && e.MediaKeySystemAccess.prototype.getConfiguration
                        ...
                        ? (n.log('Detected "webkit" Prefixed EME v0.1b. Polyfilling.'), s.setup("webkit"), "v0.1b-webkit")
            ...
            (r.prototype._checkConfig = function (t) {
                for (var i = this.keySystem, n = 0, r = t.length; n < r; n++) {
                    var s,
                        ...
                        c,
                        u = t[n],
                        h = { initDataTypes: u.initiDataTypes, audioCapabilities: [], videoCapabilities: [], persistentState: "optional", distinctiveIdentifier: "optional", sessionTypes: ["temporary"], label: u.label };
                    if (u.audioCapabilities && u.audioCapabilities.length)
                        for (c = !1, s = 0, o = u.audioCapabilities.length; s < o; s++) (a = u.audioCapabilities[s]), (_ = a.contentType.split(";")[0]), e.MSMediaKeys.isTypeSupported(i, _) && (h.audioCapabilities.push(a), (c = !0));
                    if (u.videoCapabilities && u.videoCapabilities.length)
                        for (c = !1, s = 0, o = u.videoCapabilities.length; s < o; s++) (a = u.videoCapabilities[s]), (_ = a.contentType.split(";")[0]), e.MSMediaKeys.isTypeSupported(i, _) && (h.videoCapabilities.push(a), (c = !0));
                ...
                (s.prototype.attach = function (t) {
                    return new c(
                        function (e) {
                            ...
                            (this._lastBoundSetter = i), t.addEventListener(u.MEDIA_LOADEDMETADATA, i), t.addEventListener(u.MS_NEEDKEY, l), e();
                        }.bind(this)
                    );
                }),
                (s.prototype.detach = function (t) {
                    this._lastBoundSetter && (t.removeEventListener(u.MS_NEEDKEY, l), t.removeEventListener(u.MEDIA_LOADEDMETADATA, this._lastBoundSetter), (this._lastBoundSetter = null));
                }),
                ...
                (o.prototype._onKeyMessage = function (t) {
                    t.message &&
                        t.message.buffer &&
                        (this.emit(u.KEY_SESSION_MESSAGE, { messageType: "license-request", message: t.message.buffer }), this._lastGenerateDeferred && (this._lastGenerateDeferred.resolve(!0), (this._lastGenerateDeferred = null)));
                }),
                ...
                (o.prototype._onKeyError = function () {
                    ...
                    this._lastGenerateDeferred && (this._lastGenerateDeferred.reject(t), (this._lastGenerateDeferred = null)),
                        this._lastUpdateDeferred && (this._lastUpdateDeferred.reject(t), (this._lastUpdateDeferred = null)),
                        this.emit(u.KEY_SESSION_STATUSES_CHANGE);
                }),
                (o.prototype.generateRequest = function (t, i) {
                    return new c(
                        function (t, n) {
                            (this._lastGenerateDeferred = { resolve: t, reject: n }), (this._nativeKeySession = this._nativeMediaKeys.createSession("audio/mp4", new e.Uint8Array(i), null)), this._attach();
                        }.bind(this)
                    );
                }),
                (o.prototype.update = function (t) {
                    return new c(
                        function (i, n) {
                            (this._lastUpdateDeferred = { resolve: i, reject: n }), this._nativeKeySession.update(new e.Uint8Array(t));
                        }.bind(this)
                    );
                }),
            ...
            (r.prototype._checkConfig = function (t) {
                for (var e = this.keySystem, i = document.createElement("video"), n = 0, r = t.length; n < r; n++) {
                    var s,
                        ...
                        _,
                        c = t[n],
                        u = { initDataTypes: c.initiDataTypes, audioCapabilities: [], videoCapabilities: [], persistentState: "optional", distinctiveIdentifier: "optional", sessionTypes: ["temporary"], label: c.label },
                        h = !1;
                    if (c.audioCapabilities && c.audioCapabilities.length)
                        for (h = !1, s = 0, o = c.audioCapabilities.length; s < o; s++) (a = c.audioCapabilities[s]), (_ = a.contentType.split(";")[0]), i.canPlayType(_, e) && (u.audioCapabilities.push(a), (h = !0));
                    if (c.videoCapabilities && c.videoCapabilities.length)
                        for (h = !1, s = 0, o = c.videoCapabilities.length; s < o; s++) (a = c.videoCapabilities[s]), (_ = a.contentType), i.canPlayType(_, e) && (u.videoCapabilities.push(a), (h = !0));
                ...
                (o.prototype.generateComplete = function (t) {
                    this.emit(u.KEY_SESSION_MESSAGE, { messageType: "license-request", message: t }), this._lastGenerateDeferred && (this._lastGenerateDeferred.resolve(!0), (this._lastGenerateDeferred = null));
                }),
    ...
    function (t, e, i) {
        ...
        var r = { EMPTY: "-no-robustness", SW_CRYPTO: "-sw-crypto", SW_DECODE: "-sw-decode", HW_CRYPTO: "-hw-crypto", HW_DECODE: "-hw-decode", HW_ALL: "-hw-all" };
        t.exports = n;
    },
    function (t, e, i) {
        "use strict";
        ...
        o(s, a),
            ...
            (s.prototype._init = function () {
                ...
                t.addEventListener(c.MEDIA_SOURCE_OPEN, this._onSourceOpen), t.addEventListener(c.MEDIA_SOURCE_CLOSE, this._onSourceClose), (this._mediaSource = t), (this._sourceBuffers = {});
            }),
            ...
            (s.prototype._trackBufferingProgress = function (t) {
                this._tracker.trackBytesDownloaded(t.audio.buffer.byteLength), t.video && this._tracker.trackBytesDownloaded(t.video.buffer.byteLength);
            }),
            (s.prototype.appendFragment = function (t, e, i) {
                ...
                return t
                    ...
                    .then(
                        function (t) {
                            return this._trackBufferingProgress(t), r !== this._playId ? (u.info("Append fragment dropped: playId has changed."), [!1]) : (i || this._checkStalling(Date.now() - n, e, !1), this._appendBufferData(t, e, r, n));
                        }.bind(this)
                    )
                    .catch(
                        function (t) {
                            return this._removeAppendingFragment(e), i || this._checkStalling(Date.now() - n, e, !0), this.emit(c.BUFFER_APPEND_ERROR, { error: t, canPlayNext: !0, track: s }), _.reject(t);
                        }.bind(this)
                    );
            }),
            (s.prototype._checkStalling = function (t, e, i) {
                t > 9e3 && this.emit(c.BUFFER_STALLED, { byteStart: e.byteStart, timeStart: n(e.timeStart), stallAmount: t - 9e3, didTimeout: i });
            }),
            (s.prototype._appendBufferData = function (t, e, i, n) {
                ...
                var r = n || Date.now(),
                    ...
                    o = _.defer();
                if (
                    (this.tryUpdate({ playId: i, timestamp: r, type: "append", buffer: t.audio.buffer, fragment: e, codec: t.audio.codec, init: e.init, resolve: o.resolve }),
                    s.push(o),
                    null !== t.audio.bandwidth && this._tracker.trackBufferURL(t.audio.bufferURL, { bandwidth: t.audio.bandwidth }),
                    t.video)
                ) {
                    var a = _.defer();
                    this.tryUpdate({ playId: i, timestamp: r, type: "append", buffer: t.video.buffer, fragment: e, codec: t.video.codec, init: e.init, resolve: a.resolve }),
                        s.push(a),
                        null !== t.video.bandwidth && this._tracker.trackBufferURL(t.video.bufferURL, { bandwidth: t.video.bandwidth });
                }
                return _.all(s);
            }),
            ...
            (s.prototype._getBufferedFor = function (t) {
                ...
                if (e) for (var i, n, r = 0; r < e.length; r++) if (((i = e.start(r)), (n = e.end(r)), i <= t && t <= n)) return { start: i, end: n };
                return null;
            }),
            ...
            (s.prototype.tryUpdate = function (t) {
                if (t) {
                    if (t.playId !== this._playId) return u.info("Try update dropped: playId has changed"), void this._abortUpdate(t);
                    if (t.timestamp < this._lastBufferClearTime) return u.info("Try update dropped: update is older than the last clear"), void this._abortUpdate(t);
            ...
            (s.prototype._abortUpdate = function (t) {
                t.fragment && this._removeAppendingFragment(t.fragment), t.resolve && t.resolve(!1), _.resolve().then(this.dequeueUpdates);
            }),
            ...
            (s.prototype.destroy = function () {
                var t = this._mediaSource;
                t && (u.info("Source destroyed"), t.removeEventListener("sourceopen", this._onSourceOpen), t.removeEventListener("sourceclose", this._onSourceClose), this._destroySourceBuffers(), (this._mediaSource = null));
            }),
            (s.prototype._endOfStream = function () {
                "ended" !== this._mediaSource.readyState && this.tryUpdate({ playId: this._playId, timestamp: Date.now(), type: "end" });
            }),
            (s.prototype.progress = function (t, e, i) {
                ...
                if (n && t && ("open" === n.readyState || "ended" === n.readyState)) {
                    ...
                    if (_) {
                        ...
                        Math.ceil(i / c) > Math.floor(_.end / c) && (s = t.getFragmentForTime(i)) && this.appendFragment(t, s, e).catch(r);
                        var u = Math.floor(_.end - i);
                        if (u > 10) return;
                        var h = Math.min(t.getFragmentLength(), 10 - u);
                        if (h < 1) return;
                        (o = Math.floor(_.end + h)), (s = t.getFragmentForTime(o)), s ? this.appendFragment(t, s, e).catch(r) : this._endOfStream();
    ...
    function (t, e, i) {
        ...
        r(n, s),
            ...
            (n.prototype._onPlayerLoad = function (t) {
                var e = t.logData;
                if (e)
                    if (e.impressionURLs) for (var i = e.impressionURLs.length; i--; ) this._logImpression(e.impressionURLs[i]);
            ...
            (n.prototype._onTrackingDataFinalized = function (t) {
                ...
                if (!e.noLog) {
                    ...
                    if ((i && this._setSessionId(), e.playbackId && !e.noTSV)) {
                        if ((i && this._setSequenceId(), !e.playIntended && !e.played)) return void this._rollbackSequenceId(this._sessionId);
            ...
            (n.prototype._logTrackStreamVerification = function (t) {
                var e = { play_track: t.currentTrackUri, playback_id: t.playbackId, ms_played: t.msPlayed, session_id: this._sessionId, sequence_id: this._sequenceId, next_playback_id: t.nextPlaybackId };
            ...
            (n.prototype._logError = function (t, e, i, n) {
                ...
                var s = { source: "playback", source_version: u.tagged, type: t, message: e && e.message, stack: r, json_data: i, json_data_version: "1.0.0" };
                n
    ...
    function (t, e, i) {
        ...
        (n.prototype._parseResponse = function (t, e) {
            ...
            var n = e.body;
            return n && n.cdnurl && n.cdnurl.length ? { uri: n.cdnurl[0], uris: n.cdnurl, protection: "cenc" } : ((i = new s(o.STORAGE_RETURNED_NO_TRACKS, "Storage Resolve returned no tracks for fileId " + t)), (i.fileId = t), r.reject(i));
        }),
                ...
                return (
                    ...
                    this._transport
                        ...
                        .then(function (e) {
                            var i;
                            return 200 !== e.status
                                ? ((i = new s(o.STORAGE_TRACK_MANIFEST_FAILED, "Track manifest request failed with status code " + e.status)), (i.debug.file_id = t), (i.status = e.status), r.reject(i))
                                : e.body
                                ? e.body
                                : ((i = new s(o.STORAGE_TRACK_MANIFEST_EMPTY, "Received empty manifest.")), (i.debug.file_id = t), (i.status = e.status), r.reject(i));
                        })
                );
            }),
            (t.exports = n);
        ...
        r(n, s),
            ...
            (n.prototype._checkPlayedThreshold = function () {
                ...
                !t ||
                    ...
                    ((this._playedThresholdReached = !0), this.emit(_.TRACKER_PLAYED_THRESHOLD_REACHED, { played: t.msPlayed, threshold: this._playedThreshold }));
            }),
            (n.prototype.trackLoadStart = function (t, e, i, n) {
                ...
                var s = n.referrer || {};
                (r.referrer = s.name || a.UNKNOWN), (r.referrerVersion = s.version || a.UNKNOWN), (r.referrerVendor = s.vendor || a.UNKNOWN);
                var c = n.format || {};
            ...
            (n.prototype.trackLoadDone = function (t) {
                ...
                if (e) {
                    var i = Date.now();
                    (e.msInitLatency = i - e.bufferLoadStartTime), (e.lastPlayStartTime = i), (e.localTimeMs = i), (e.position = t), (e.startPosition = t), e.addStartSegment();
                }
            }),
            ...
            (n.prototype.trackSeekRebuffering = function (t) {
                this._trackingData && (t > this._trackingData.maxMsSeekRebuffering && (this._trackingData.maxMsSeekRebuffering = t), (this._trackingData.msSeekRebuffering += t));
            }),
            ...
            (n.prototype.trackPositionChanged = function (t, e) {
                ...
                if (i) {
                    ...
                    t !== n &&
                        (i.addEndSegment(),
                        t > n ? (i.nSeeksForward++, (i.msSeeksForward += t - n)) : t < n && (i.nSeeksBackward++, (i.msSeeksBackward += n - t)),
            ...
            (n.prototype.trackProgress = function (t, e) {
                ...
                if (i) {
                    var n = Date.now(),
                        r = 0;
                    i.lastPlayStartTime && (r = n - i.lastPlayStartTime), (i.lastPlayStartTime = n), i.addMSPlayed(r), this._checkPlayedThreshold(), (i.position = t), e && i.trackBitrate(e, r);
                }
            }),
    ...
    function (t, e, i) {
        ...
        (n.create = function () {
            ...
            (n.prototype._calculateUnion = function () {
                for (var t = this._segments.slice(0), e = 0, i = 0, n = 0, r = 0, s = 0, o = 0, a = this.maxContinuous; s < t.length; s++)
                    s % 2 != 0 && void 0 !== t[s - 1] && "start" === t[s - 1].type && ((o = t[s].time - t[s - 1].time), (a = o > a ? o : a));
                for (
                    ...
                    "start" === t[r].type && (0 === i && (n = r), ++i), "end" === t[r].type && 0 === --i && (e += t[r].time - t[n].time);
                return e;
            }),
    ...
    function (t, e, i) {
        ...
        (n.prototype.clear = function () {
            ...
            (n.prototype.track = function (t, e) {
                var i = this._map[t];
                i || ((i = new r.Node({ url: t, segments: 0, bandwidths: [] })), this._list.append(i), (this._map[t] = i));
                var n = i.value;
            ...
            (n.prototype.toJSON = function () {
                for (var t = [], e = this._list.first; e; ) {
                    ...
                    t.push({ url: i.url, segments: i.segments, avg_bw: parseFloat((r / n.length).toFixed(7)) }), (e = e.next);
                }
    ...
    function (t, e, i) {
        ...
        (n.create = function (t) {
            ...
            (n.prototype.getSegmentURLs = function (t, e, i, n, r) {
                ...
                return { audio: s.replace("{{segment_timestamp}}", i), video: o.replace("{{segment_timestamp}}", i), audioLogging: s, videoLogging: o };
            }),
            (n.prototype.getManifest = function (t) {
    ...
    function (t, e, i) {
        "use strict";
        function n(t) {
            (this._transport = t.transport), (this._sdk = t.sdk || { name: "", version: "" }), (this._securityLevel = t.securityLevel), (this._urls = {}), this._init();
        }
        var r = i(0),
            s = i(105),
            o = i(4);
        (n.prototype._init = function () {
            ...
            (n.prototype.get = function (t, e) {
                ...
                var a = ["@webgate/melody/v1/license_url", "?keysystem=", t, "&mediatype=", e, "&sdk_name=", this._sdk.name, "&sdk_version=", this._sdk.version].join("");
                return this._transport
                    .request(a, {
                        responseType: "json",
                        retry: {
                    ...
                    .then(
                        function (t) {
                            var e = t.body;
                            if (200 === t.status)
                                return (e.expires *= 1e3), (e.uri = "@webgate/" + e.uri), this._securityLevel && (e.uri += [-1 !== e.uri.indexOf("?") ? "&" : "?", "sl=", this._securityLevel].join("")), (this._urls[i] = e), e.uri;
                            var n;
                            return (
                                400 === t.status && e && "deprecated-version" === e.code
                                    ? ((n = new s(o.LICENSE_RESOLVER_DEPRECATED_VERSION, "This version of the SDK is no longer supported. Please upgrade")), (n.canPlayNext = !1), n.fatal())
                                    : (n = new s(o.LICENSE_RESOLVER_CANT_RESOLVE_URL, "License URL endpoint responded with status " + t.status)),
                                (n.status = t.status),
                                r.reject(n)
                            );
                        }.bind(this)
    ...
    function (t, e, i) {
        "use strict";
        function n(t, e) {
            Error.call(this, e), (this.code = t), (this.message = e), (this.status = -1), (this.debug = {}), (this.canPlayNext = !0);
        }
        (n.prototype = new Error()),
            (n.prototype.constructor = n),
    ...
    function (t, e, i) {
        "use strict";
        t.exports = { EMPTY: "EMPTY", SW_CRYPTO: "SW_CRYPTO", SW_DECODE: "SW_DECODE", HW_CRYPTO: "HW_CRYPTO", HW_DECODE: "HW_DECODE", HW_ALL: "HW_ALL" };
    },
    function (t, e, i) {
        "use strict";
        function n(t) {
        ...
        r(n, s),
            ...
            (n.prototype._handlePlayerInitError = function (t) {
                this._trackPlayerPromise.reject(new l(a.LIST_PLAYER_NO_TRACK_PLAYER, t.message || "Track player promise was rejected."));
            }),
            (n.prototype._handleCapped = function () {
                var t = this._currentTrack;
                t && this.emit(d.LIST_PLAYER_CAPPED, { uid: this._uid, track: t, options: this._currentTrackOptions, list: this._loadedList });
            }),
            (n.prototype._handlePlaying = function (t) {
                var e = this._currentTrack;
                e && this.emit(d.LIST_PLAYER_PLAYING, { uid: this._uid, track: e, options: this._currentTrackOptions, list: this._loadedList, position: t.position });
            }),
            (n.prototype._handlePaused = function (t) {
                var e = this._currentTrack;
                e && this.emit(d.LIST_PLAYER_PAUSED, { uid: this._uid, track: e, options: this._currentTrackOptions, list: this._loadedList, position: t.position });
            }),
            ...
            (n.prototype._handleEnded = function () {
                var t = this._currentTrack;
                t && (this.emit(d.LIST_PLAYER_TRACK_ENDED, { uid: this._uid, track: t, options: this._currentTrackOptions, list: this._loadedList }), this.next(h.TRACK_DONE));
            }),
            (n.prototype._handleTimeout = function () {
                var t = this._currentTrack;
                t && (this.emit(d.LIST_PLAYER_TRACK_TIMEOUT, { uid: this._uid, track: t, options: this._currentTrackOptions, list: this._loadedList }), this.next(h.TRACK_ERROR));
            }),
            (n.prototype._handlePositionChanged = function (t) {
                var e = this._currentTrack;
                e && this.emit(d.LIST_PLAYER_POSITION_CHANGED, { uid: this._uid, track: e, options: this._currentTrackOptions, list: this._loadedList, position: t.position });
            }),
            (n.prototype._handleDurationChanged = function (t) {
                var e = this._currentTrack;
                e && this.emit(d.LIST_PLAYER_DURATION_CHANGED, { uid: this._uid, track: e, options: this._currentTrackOptions, list: this._loadedList, position: t.position, duration: t.duration });
            }),
            (n.prototype._handlePlayedThresholdReached = function (t) {
                var e = this._currentTrack;
                e && this.emit(d.LIST_PLAYER_PLAYED_THRESHOLD_REACHED, { uid: this._uid, track: e, options: this._currentTrackOptions, list: this._loadedList, total: t.total, threshold: t.threshold, position: t.position });
            }),
            (n.prototype._handleError = function (t) {
                if (this._currentTrack) {
                    ...
                    e || this._listErrorCount++,
                        t.canPlayNext && (e || this._listErrorCount <= this._maxListErrors ? this.next(h.TRACK_ERROR) : this.emit(d.LIST_PLAYER_MAX_LIST_ERRORS_REACHED, { count: this._listErrorCount, threshold: this._maxListErrors }));
                }
            }),
            ...
            (n.prototype._replaceCurrentList = function (t, e) {
                return (
                    this.emitSync(d.LIST_PLAYER_BEFORE_LIST_CHANGE, { newList: t, newOptions: e, oldList: this._loadedList, oldOptions: this._loadedOptions }),
                    (this._loadedList = t),
            ...
            (n.prototype._changeTrack = function (t, e, i) {
                ...
                this.emitSync(d.LIST_PLAYER_BEFORE_TRACK_LOAD, { list: this._loadedList, newTrack: t, oldTrack: this._currentTrack }), this._uid++;
                ...
                if ("options" in t) {
                    var l = t.options;
                    "paused" in l && (s = !l.paused), "position" in l && (a = l.position), "playedThreshold" in l && (c = l.playedThreshold);
                }
                (this._currentTrack = t), (this._currentTrackOptions = { reason: e, paused: !s, position: a, playedThreshold: c });
                ...
                return this._getTrackPlayer().then(
                    function (e) {
                        return this._currentSeqId !== i ? _.CANCELLED : (o.resolve(e.load(t, { uriProperty: "playableURI", autoplay: s, position: a, playedThreshold: c, continuePrevious: u }, p)).catch(function () {}), _.SUCCESS);
                    }.bind(this)
                );
            }),
                ...
                return e.next(n).then(
                    function (n) {
                        return this._currentSeqId !== i
                            ...
                            ? this.next(t)
                            : n === u.LIST_END
                            ? (this.emit(d.LIST_PLAYER_LIST_ENDED, { list: e, reason: h.END_PLAY }), this.clear(t), _.LIST_END)
                            : n.playable
            ...
            (n.prototype.stop = function (t) {
                ...
                return (
                    ...
                    this._getTrackPlayer().then(
                        function (t) {
                            return t.stop(e), this.emit(d.LIST_PLAYER_STOPPED, { uid: this._uid, options: this._currentTrackOptions, list: this._loadedList }), _.SUCCESS;
                        }.bind(this)
                    )
                );
            }),
            ...
            (n.prototype.setRepeatMode = function (t) {
                if (!(t in c)) return o.reject(new l(a.LIST_PLAYER_INVALID_ARGUMENT, "The value of repeat mode is not a correct RepeatMode enum value"));
                if (this._repeatMode !== t) {
                    (this._repeatMode = t), this.emit(d.LIST_PLAYER_REPEAT_MODE_CHANGED, { player: this, repeatMode: t });
                    var e = this._loadedList;
            ...
            (n.prototype.setVolume = function (t, e) {
                return this._getTrackPlayer().then(
                    function (i) {
                        return i.setVolume(t), this.emit(d.LIST_PLAYER_VOLUME_CHANGED, { volume: t, commandId: e || null }), _.SUCCESS;
                    }.bind(this)
                );
            }),
            ...
            (n.prototype.getState = function () {
                return this.getPlayerState().then(
                    function (t) {
                        return { playbackState: t, track: this._currentTrack, list: this._loadedList, options: this._loadedOptions };
                    }.bind(this)
                );
            }),
            (t.exports = n);
    ...
    function (t, e, i) {
        "use strict";
        var n = { NULL_VALUE: new (function () {})(), LIST_START: new (function () {})(), LIST_END: new (function () {})(), FORBIDDEN: new (function () {})() };
        t.exports = n;
    },
    function (t, e, i) {
        "use strict";
        ...
        r(n, s),
            ...
            (n.prototype._onBeforePlayerLoad = function (t) {
                ...
                if (e) {
                    ...
                    var n = t.options;
                    e.setPaused(!n.autoplay), this._setCurrentTrackPosition(n ? n.position || 0 : 0), this._updateState("before_track_load"), (this._initialUpdateSent = !1);
                }
            }),
            (n.prototype._onCapped = function () {
                this._listPlayer.clear("capped"), (this._currentContext = null), this._updateState("capped"), this._setCurrentTrackPosition(void 0), (this._lastProcessedStateId = null), this.emit(u.TP_API_STATE_CLEARED);
            }),
            (n.prototype._onConnectionId = function (t) {
                if (((this._connectionId = t.id), !this._isDeregistering)) {
                    ...
                    this._abbaClient &&
                        ...
                        o
                            .all([e, this._listPlayer.getVolume(), this._descriptorPromise.then(this._parseDescriptor.bind(this))])
                            .then(
                                this.register.bind(this),
                                function (t) {
                                    p.info("Skipping registration due to error", t), this.emit(u.TP_API_REGISTRATION_ABORTED, { reason_error: t });
                                }.bind(this)
                            )
                            .catch(function () {});
                }
            ...
            (n.prototype._onPlayPause = function (t, e) {
                ...
                i &&
                    ...
                    e.track && this._shouldSendUpdateForEvent(e.track.stateId) ? this._updateState(t ? "pause" : "resume") : ((this._lastProcessedStateId = null), this._emitStateChanged()));
            }),
            (n.prototype._onPlayThresholdReached = function (t) {
                (this._initialUpdateSent = !0), this._setAllTrackPositions(t.position), this._updateState("played_threshold_reached");
            }),
            ...
            (n.prototype._onPositionChanged = function (t) {
                this._loading ||
                    (this._setCurrentTrackPosition(t.position), t.track && this._shouldSendUpdateForEvent(t.track.stateId) ? this._updateState("position_changed") : ((this._lastProcessedStateId = null), this._emitStateChanged()));
            }),
            (n.prototype._onProgress = function (t) {
                if (!this._loading && this._currentContext) {
                    ...
                    if (e) {
                        ...
                        this._initialUpdateSent && n > 0 && Date.now() - this._lastUpdateStateTime > n && this._updateState("progress");
                    }
                }
            }),
            (n.prototype._onTrackDataEvent = function (t, e) {
                switch (t) {
                    ...
                    case "finalized":
                        ...
                        i && ((i.playback_stats = e.playbackStats), this._updateState("track_data_finalized", i)), (this._nextFinalizedDataPayload = null), this._waitingForTrackingData.resolve(!0);
                        break;
                    default:
                        return;
                }
            ...
            (n.prototype._deregisterFromService = function (t) {
                ...
                return this._transport.request(r, { authorize: !0, method: "DELETE", payload: JSON.stringify(n), responseType: "json", retry: A }).then(
                    function (t) {
                        if (200 !== t.status && 204 !== t.status) return (this._registered = !0), !1;
                        var e = t.body;
                        return e && (e.endsong && E.log(e.endsong), e.endsongs && f.log(e.endsongs)), this._clearSessionData(), this.emit(u.TP_API_DEREGISTERED), !0;
                    }.bind(this)
                );
            }),
            (n.prototype._emitError = function (t, e) {
                this._logger.logJSSDKError({ source: "tpapi-client", version: l.tagged, type: t.code, message: t && t.message, stack: t && t.stack, json_data: e, json_data_version: "1.0.0" }).catch(function (t) {
            ...
            (n.prototype._emitStateChanged = function () {
                ...
                t && this.emit(u.TP_API_STATE_CHANGED, { stateMachine: t.getStateMachine(), stateRef: t.getInternalStateRef(), position: this._currentTrackPosition || 0, duration: this._currentTrackDuration || 0, paused: t.isPaused() });
            }),
            (n.prototype._generateStatePayload = function (t, e) {
                return {
                    ...
                    seq_nums: void 0,
                    state_ref: t,
                    sub_state: { playback_speed: t && !t.paused ? 1 : 0, position: this._currentTrackPosition, duration: this._currentTrackDuration || void 0, stream_time: this._totalStreamTime },
            ...
            (n.prototype._handleRegisterResponse = function (t) {
                var e;
                if (429 === t.status)
                    return (e = new d(c.TP_MAX_SUBSCRIPTIONS_REACHED, "Max connections reached").fatal()), (e.maxedSubscriptions = !0), (e.status = t.status), this.emit(u.TP_API_MAX_SUBSCRIPTIONS_REACHED, { error: e }), o.reject(e);
                if (
                    (403 === t.status && t.body && "PREMIUM_REQUIRED" === t.body.error_type
                        ? (e = new d(c.TP_REGISTRATION_FAILED_NON_PREMIUM, "Cannot register to Track Playback with non-premium user.").fatal())
                        : 200 !== t.status
                        ? (e = new d(c.TP_REGISTRATION_FAILED_WITH_STATUS, "track-playback service responded with status " + t.status + " when registering device").fatal())
                        : t.body || (e = new d(c.TP_NO_RESPONSE_BODY, "Unexpected empty response body from registration request.").fatal()),
                    e)
                )
                    return (e.status = t.status), o.reject(e);
                var i = t.body;
                return i.endsong && E.log(i.endsong), i.endsongs && f.log(i.endsongs), (this._sequenceNumber = i.initial_seq_num), (this._registered = !0), this.emit(u.TP_API_REGISTERED, { deviceId: this._deviceId }), !0;
            }),
            (n.prototype._handleStateConflictResponse = function (t) {
                if (t.status >= 200 && t.status < 300) {
                    ...
                    var s = new d(c.TP_CONFLICT_REQUEST_FAILED_WITH_STATUS, "Track-Playback service responded with " + t.status);
                    (s.status = t.status), this._emitError(s);
                }
            }),
            (n.prototype._handleStateUpdateResponse = function (t, e) {
                var i;
                if (200 !== e.status) return (i = new d(c.TP_PARSE_STATE_UPDATE_FAILED_WITH_STATUS, "Service responded with status " + e.status)), (i.status = e.status), o.reject(i);
                if (!e.body) return (i = new d(c.TP_UPDATE_REQUEST_EMPTY_RESPONSE, "Unexpected empty response body from state update request.")), (i.status = e.status), o.reject(i);
                var n = e.body;
                ...
                return this._isCurrentStateRef(t) ? (r.setStateMachine(s), r.setCurrentState(a), this._emitStateChanged(), o.resolve()) : o.resolve();
            }),
            ...
            (n.prototype._logUnsentStateUpdate = function (t) {
                p.info("Unsent state update.", t),
                    this._logger.logClientEvent({ source: "tpapi-client", source_version: l.tagged, source_vendor: "spotify", event: "unsent-state-update", event_version: "1.0.0", json_data: t }).catch(function (t) {
                        p.error("Track-Playback Logging Error", t);
                    });
            }),
            (n.prototype._logout = function () {
                this._listPlayer.pause().catch(function () {}),
                    ...
                    this.deregister().then(
                        function (t) {
                            (this._currentContext = null), this._setCurrentTrackPosition(void 0), t && this.emit(u.TP_API_LOGOUT);
                        }.bind(this)
                    );
            }),
            (n.prototype._parseDescriptor = function (t) {
                return (this._deviceId = t.getId()), (this._deviceInfo = t.toTrackPlaybackJSON()), (this._manifestFormats = t.getManifestFormats()), !0;
            }),
            ...
            (n.prototype._rejectState = function (t) {
                ...
                if ((void 0 !== t && e.push(t), this._registered && !this._isSendingConflict && e.length)) {
                    ...
                    this._transport
                        .request(o, { authorize: !0, method: "POST", headers: { "Content-Type": "application/json" }, responseType: "json", payload: JSON.stringify(r), retry: A })
            ...
            (n.prototype._replaceState = function (t) {
                ...
                if (((this._lastProcessedStateId = r.state_id), s && s.state_id === r.state_id)) {
                    ...
                    o.setStateMachine(i), o.setCurrentState(n), n.paused ? (o.setPaused(!0), e.pause()) : (o.setPaused(!1), e.resume());
                    var a = parseInt(t.seek_to, 10);
                    o.allowSeeking() && !isNaN(a) && (e.seek(a), this._setCurrentTrackPosition(a)), this._updateState("modify_current_state");
                } else {
                    ...
                    var c = t.seek_to || 0;
                    _.setInitialPosition(c), (this._loading = !0), (this._switchingContext = !0), e.play(_, { reason: "remote" });
                }
            }),
            (n.prototype._sendDevicesRequest = function (t, e) {
                var i = this._endpoint + "/v1/devices";
                return (
                    "PUT" === t && (i += "/" + this._deviceId), this._transport.request(i, { authorize: !0, method: t || "POST", headers: { "Content-Type": "application/json" }, responseType: "json", payload: JSON.stringify(e), retry: g })
                );
            }),
            ...
            (n.prototype._updateState = function (t, e) {
                if (this._registered) {
                    var i, n;
                    if ((e ? ((i = e.state_ref), (n = e)) : ((i = this._currentContext ? this._currentContext.getStateRef() : null), (n = this._generateStatePayload(i, t))), !this._wasStatePayloadSentRecently(n)))
                    ...
                    var r = function () {
                            (this._isSendingUpdate = !1), this._queueSendUpdate.length && this._updateState(this._queueSendUpdate.join(",")), p.info("State update sent.", t, n);
                        }.bind(this),
                        s = this._endpoint + "/v1/devices/" + this._deviceId + "/state";
                    (this._lastUpdateStateTime = Date.now()),
                        this._transport
                            .request(s, { authorize: !0, method: "PUT", headers: { "Content-Type": "application/json" }, responseType: "json", payload: JSON.stringify(n), retry: g })
            ...
            (n.prototype._wasStatePayloadSentRecently = function (t) {
                ...
                var r = t.sub_state,
                    s = e.sub_state;
                return r.playback_speed !== s.playback_speed || r.position !== s.position || r.duration !== s.duration || t.previous_position !== e.previous_position;
            }),
            (n.prototype.deregister = function () {
                return this._registered
                    ? ((this._isDeregistering = !0),
                      ...
                      this._listPlayer.getPlayerState().then(
                          function (t) {
                              return o.all([this._deregisterFromService(t), this._waitingForTrackingData.promise, this._listPlayer.stop().catch(function () {})]).spread(
                                  function (t) {
        ...
        (n.prototype._deferFn = function (t) {
            ...
            (n.prototype.sync = function () {
                ...
                return (
                    (this._ts = Date.now()),
                    e < this._threshold
                        ? (this._cancelFn && this._deferredTimer && this._cancelFn(), clearTimeout(this._deferredTimer), void (this._deferredTimer = setTimeout(this._deferFn.bind(this, t), this._threshold)))
                        : !0 === this._blockInital
        ...
        (n.create = function (t, e) {
            ...
            (n.prototype.startAtState = function (t) {
                ...
                (this._currentStateIndex = -1),
                    (this._currentState = { decoy: !0, paused: !!t.paused, track: -1, state_id: null, transitions: { advance: t, show_next: i.show_next, show_prev: i.show_prev, skip_next: t, skip_prev: i.skip_prev } });
            }),
    ...
    function (t, e, i) {
        "use strict";
        function n(t, e) {
            for (var i = e.manifest, n = e.metadata.uri, c = r.from(n), u = !(!c || c.type !== r.Type.AD), h = 0, d = t.length; h < d; h++) {
                var l = t[h];
                if (l in i) {
                    var p = i[l];
                    if (p.length) {
                        ...
                        if (E.file_id || E.file_url) {
                            ...
                            if ((f && !o.test(f) && (f = null), T || f)) {
                                var y;
                                return (
                                    (y = e.track_type ? e.track_type.toLowerCase() : l === s.MANIFEST_IDS_VIDEO ? "video" : "audio"),
                                    {
                                        uri: n,
                                        uriType: c && c.type,
                                        fileId: T,
        ...
        var r = i(39),
            ...
            a = /^(.+?)\/([^.\/]+)(\.[^\/]*)?$/,
            _ = {};
        (_[s.FILE_URLS_MP3] = "MP3"), (_[s.FILE_URLS_EXTERNAL] = "MP3"), (_[s.FILE_IDS_MP4] = "MP4"), (_[s.FILE_IDS_MP4_DUAL] = "MP4"), (_[s.MANIFEST_IDS_VIDEO] = "MANIFEST"), (t.exports = n);
    },
    function (t, e, i) {
        "use strict";
        function n(t) {
        ...
        r(n, s),
            (n.prototype._init = function () {
                ...
                e.on(_.TP_API_LOGOUT, this._onTPAPILogout.bind(this)),
                    ...
                    this.proxyEmit(this._playbackStateObserver, _.PLAYBACK_STATE_OBSERVER_STATE_CHANGED, _.STREAMER_STATE_CHANGED),
            ...
            (n.prototype._onError = function (t, e) {
                var i = e.error;
                i && i.registration && t === a.TRACK_PLAYBACK && this.emit(_.STREAMER_REGISTRATION_ERROR, { error: i }), this.emit(_.STREAMER_ERROR, { source: t, name: e.name, error: i }), this._client.notifyError(t, e.name, e.error);
            }),
    ...
    function (t, e, i) {
        ...
        function n(t, e) {
            a.call(this);
            var i = e || {};
            (this._tpApiClient = t), (this._numPreviousTracks = i.numPrevious || 2), (this._numNextTracks = i.numNextTracks || 2), (this._state = null), this._init();
        }
        ...
        o(n, a),
            ...
            (n.prototype._init = function () {
                this._tpApiClient.on(c.TP_API_STATE_CHANGED, this._onStateChanged.bind(this)), this._tpApiClient.on(c.TP_API_STATE_CLEARED, this._onStateCleared.bind(this));
            }),
            ...
            (n.prototype._onStateChanged = function (t) {
                ...
                var l = this,
                    ...
                    E = { current_track: p(i, u), next_tracks: this._getNextStates(u, _).map(p.bind(null, null)), previous_tracks: this._getPreviousStates(u, _).map(p.bind(null, null)) };
                i || (i = E.current_track ? E.current_track.duration_ms : 0);
                var f = this._getRepeatSetting(o),
                    T = { context: { uri: null, metadata: {} }, bitrate: 0, position: e, duration: i, paused: s, shuffle: this._getShuffleSetting(o), repeat_mode: f, track_window: E, timestamp: n, restrictions: h, disallows: d },
                    y = o.tracks[u.track];
                y && y.metadata && (y.metadata.context_uri && (T.context.uri = y.metadata.context_uri), y.metadata.context_description && (T.context.metadata.context_description = y.metadata.context_description)),
                    (this._state = T),
